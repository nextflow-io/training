...
Bevor wir den Container verlassen, verschieben wir die GVCF-Dateien, das endgültige Multi-Sample-VCF und alle ihre Indexdateien manuell in das Dateisystem außerhalb des Containers.
