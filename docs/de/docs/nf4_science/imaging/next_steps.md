...
- **[Side Quests](../../side_quests/)**: Fortgeschrittene Themen für Pipeline-Entwickler

### Der Community beitreten

- **[Nextflow Slack](https://www.nextflow.io/slack-invite.html)**: Hilfe erhalten und mit anderen Nutzern in Kontakt treten
...
- **[Nextflow Documentation](https://www.nextflow.io/docs/latest/)**: Vollständige Referenzdokumentation
- **[nf-core Documentation](https://nf-co.re/docs)**: Richtlinien und Best Practices

## Mitmachen

- **Zu nf-core beitragen**: Hilf mit, Pipelines oder Dokumentation zu verbessern
- **Deine Workflows teilen**: Steuere deine eigenen Pipelines zur Community bei
- **An Veranstaltungen teilnehmen**: Nimm am Nextflow Summit und Community-Trainings teil
