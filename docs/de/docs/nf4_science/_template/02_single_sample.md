...
1. **Schreibe einen einstufigen Workflow, der {TOOL_A_ACTION} ausführt.**
   Dies umfasst das Erstellen eines Moduls, das Importieren und das Aufrufen in einem Workflow.
...
### 1.2. {TOOL_A_NAME}-Modul schreiben
...
### 2.1. {TOOL_B_NAME}-Modul schreiben
