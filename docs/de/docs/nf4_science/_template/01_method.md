...
In diesem Abschnitt testen wir die Befehle, aus denen die Einzelproben-Verarbeitung besteht.
...
Deine Eingabeaufforderung sollte wieder normal sein.
Damit ist der Test der Einzelproben-Verarbeitung abgeschlossen.
...
In diesem Abschnitt testen wir die zusätzlichen Befehle, die für die Mehrproben-Verarbeitung benötigt werden.
