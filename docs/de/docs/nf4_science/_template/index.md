...
additional_information:
  ...
  learning_objectives:
    ...
    - Implementiere Multi-Proben-Aggregation mit relevanten Channel-Operatoren
  audience_prerequisites:
...
Wir haben dies in drei Teile unterteilt, die sich jeweils auf bestimmte Aspekte der Anwendung von Nextflow auf einen {DOMAIN}-Anwendungsfall konzentrieren.
...
| [Teil 2: Einzelproben-Verarbeitung](./02_single_sample.md) | Erstellen einer Pipeline, die {PART2_SUMMARY}, und anschließendes Skalieren auf mehrere Proben                                | 60 Min.          |
| [Teil 3: Multi-Proben-Aggregation](./03_multi_sample.md)  | Hinzufügen von Multi-Proben-{AGGREGATION_SUMMARY} mithilfe von Channel-Operatoren zur Aggregation von Einzelproben-Ausgaben | 45 Min.          |

Am Ende dieses Kurses kannst du grundlegende Nextflow-Konzepte und -Werkzeuge auf einen typischen {DOMAIN}-Anwendungsfall anwenden.
