...
-   :material-slack:{ .lg .middle } __Slack-Kanal__
...
-   :octicons-comment-ai-16:{ .lg .middle } __Seqera AI-Assistent__
...
-   :material-account-hard-hat:{ .lg .middle } __Professioneller Support__
