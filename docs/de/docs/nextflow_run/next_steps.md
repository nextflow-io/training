...
- Starte mit nf-core mit [Build with nf-core](../hello_nf-core/index.md)
- Lerne Troubleshooting-Techniken mit der [Debugging Side Quest](../side_quests/debugging/index.md)
