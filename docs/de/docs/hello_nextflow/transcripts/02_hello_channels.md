...
Wir wollen nicht die Metadaten der Datei an die Eingabe übergeben. Wir wollen den Inhalt dieser Datei übergeben. Wenn wir uns die _greetings.csv_-Datei ansehen, kannst du hier sehen, dass sie diese verschiedenen Variablen hier hat. _Hello, Bonjour, Hola_ wieder. Und das sind die Dinge, die wir wirklich an unseren Prozess übergeben wollen, nicht nur die Datei selbst als einzelnes Objekt.
