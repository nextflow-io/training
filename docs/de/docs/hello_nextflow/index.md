...
In praktischen Beispielen und angeleiteten Übungen lernst du die Grundlagen der Pipeline-Entwicklung mit Nextflow: Prozesse definieren, sie zu Pipelines verbinden, Dateien und Software-Abhängigkeiten verwalten, Ausführung mühelos parallelisieren und Workflows in verschiedenen Rechenumgebungen ausführen.

Du erhältst die Fähigkeiten und das Selbstvertrauen, um mit der Entwicklung und Ausführung eigener Workflows mit Nextflow zu beginnen.
