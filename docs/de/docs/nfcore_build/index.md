...
additional_information:
  ...
  audience_prerequisites:
    ...
    - "**Kurse:** Der Kurs [Hello Nextflow](../hello_nextflow/index.md) und [Use nf-core](../nfcore_use/index.md) müssen abgeschlossen sein, oder gleichwertige Kenntnisse müssen vorhanden sein."
