...
Du hast damit begonnen, einen einfachen Nextflow-Workflow in eine nf-core-Pipeline umzuwandeln.
...
- **Community-Module** aus dem nf-core-Repository (`find/concatenate`) neben deinen benutzerdefinierten Modulen
