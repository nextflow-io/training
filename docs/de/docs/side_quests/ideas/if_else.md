...
Eine Lösung für diese Übung findest du in `containers/solutions/hello-containers-4.1.nf`.
...
Eine Lösung für diese Übung findest du in `containers/solutions/hello-containers-4.2.nf`.
