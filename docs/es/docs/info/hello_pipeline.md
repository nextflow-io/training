...
Otros cursos utilizan este pipeline, o partes de él, como punto de partida.

Esta página resume el estado del pipeline tal como se encuentra al completar el curso Hello Nextflow.
...
4. **`cowpy`:** Genera arte ASCII utilizando la herramienta `cowpy`
...
Puede encontrar algunas variaciones en los detalles específicos dependiendo del curso en el que se presente el pipeline.
