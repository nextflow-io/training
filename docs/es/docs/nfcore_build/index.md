...
additional_information:
  ...
  audience_prerequisites:
    ...
    - "**Cursos:** Debe haber completado [Hello Nextflow](../hello_nextflow/index.md) y [Use nf-core](../nfcore_use/index.md), o tener experiencia equivalente."
...
**Build with nf-core es una introducción práctica al uso de recursos y mejores prácticas de nf-core.**
...
Hemos dividido esto en cuatro partes que se enfocarán cada una en aspectos específicos del uso de recursos de nf-core.

| Capítulo del curso                                                | Resumen                                                                                                                                                                       | Duración estimada |
| ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [Parte 1: Reescribir Hello para nf-core](./01_rewrite_hello.md)   | Adaptar un workflow existente a la estructura de plantilla de nf-core, comenzando desde el workflow simple producido en el curso [Hello Nextflow](../hello_nextflow/index.md) | 60 mins           |
| [Parte 2: Usar un módulo de nf-core](./02_use_module.md)          | Explorar la biblioteca de módulos de la comunidad y aprender a integrar módulos preconstruidos y probados que envuelven herramientas bioinformáticas comunes                  | 30 mins           |
| [Parte 3: Crear un módulo de nf-core](./03_make_module.md)        | Crear su propio módulo al estilo nf-core usando la estructura específica, convenciones de nomenclatura y requisitos de metadatos establecidos por nf-core                     | 30 mins           |
| [Parte 4: Añadir validación de entrada](./04_input_validation.md) | Implementar validación de entrada tanto para parámetros de línea de comandos como para archivos de datos de entrada usando nf-schema                                          | 30 mins           |
