...
- **El directorio `solutions`** contiene archivos de módulos completos y soluciones específicas de cada parte que pueden servir como punto de partida para la siguiente parte.
