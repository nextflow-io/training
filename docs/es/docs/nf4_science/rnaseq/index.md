...
Este curso se basa en el entrenamiento para principiantes [Hello Nextflow](../../hello_nextflow/index.md) y demuestra cómo usar Nextflow en el contexto específico del análisis de RNAseq masivo.
