---
title: Entrenamiento de Nextflow
...
- :material-book-open-variant:{ .lg .middle } **Cursos de autoservicio**
...
- :material-information-outline:{ .lg .middle } **Información adicional**
...
- :material-walk:{ .lg .middle } **Pista introductoria**
...
- :material-run:{ .lg .middle } **Pista avanzada**
