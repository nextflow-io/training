...
1. Abra VS Code
2. Vaya a la vista de Extensiones haciendo clic en el ícono de extensiones a la izquierda: ![ícono de extensiones](../../../en/docs/side_quests/img/extensions_icon.png) (atajo `Ctrl/Cmd+Shift+X` si está ejecutando VS Code localmente)
3. Busque "Nextflow"
4. Instale la extensión oficial de Nextflow

![Instalar Extensión de Nextflow](../../../en/docs/side_quests/img/install_extension.png)
...
- **Explorador de Archivos** haga clic (![ícono del explorador de archivos](../../../en/docs/side_quests/img/files_icon.png)) (`Ctrl/Cmd+Shift+E`): Los archivos y carpetas locales en su sistema. Mantenga esto abierto a la izquierda para navegar entre archivos
...
![Demostración de Sintaxis](../../../en/docs/side_quests/img/syntax_showcase.png)
...
![Auto-completado de canal](../../../en/docs/side_quests/img/autocomplete_channel.png)
...
![Auto-completado de operaciones de canal](../../../en/docs/side_quests/img/autocomplete_operators.png)
...
![Auto-completado de propiedades de tarea](../../../en/docs/side_quests/img/autocomplete_task.png)

#### Configuración

Abra nextflow.config y escriba `process.` en cualquier lugar para ver directivas de proceso disponibles:

![Auto-completado de configuración](../../../en/docs/side_quests/img/autocomplete_config.png)
...
![Subrayado de error](../../../en/docs/side_quests/img/error_underline.png)
...
![Filtrar el panel de problemas](../../../en/docs/side_quests/img/active_file.png)

Haga clic en cualquier problema para saltar directamente a la línea problemática

![Panel de Problemas](../../../en/docs/side_quests/img/problems_panel.png)
...
![Ir a definición](../../../en/docs/side_quests/img/syntax.png)
...
![Seguir enlace](../../../en/docs/side_quests/img/follow_link.png)
...
![Navegación de símbolos](../../../en/docs/side_quests/img/symbols.png)
...
![Encontrar referencias](../../../en/docs/side_quests/img/references.png)
...
El panel de Esquema, ubicado en la barra lateral del Explorador (haga clic en ![ícono del Explorador](../../../en/docs/side_quests/img/files_icon.png)), proporciona una visión general conveniente de todos los símbolos en su archivo actual. Esta característica le permite navegar y gestionar rápidamente la estructura de su código mostrando funciones, variables y otros elementos clave en una vista jerárquica.

![Panel de esquema](../../../en/docs/side_quests/img/outline.png)
...
![Vista previa DAG](../../../en/docs/side_quests/img/dag_preview.png)
...
![Vista previa DAG workflow interno](../../../en/docs/side_quests/img/dag_preview_inner.png)
...
![Editor dividido](../../../en/docs/side_quests/img/split_editor.png)
...
![Búsqueda de proyecto](../../../en/docs/side_quests/img/project_search.png)
...
![Plegado de código](../../../en/docs/side_quests/img/code_folding.png)
...
Abra el panel de Control de Fuente usando el botón de control de fuente (![ícono de Control de fuente](../../../en/docs/side_quests/img/source_control_icon.png)) (`Ctrl+Shift+G` o `Cmd+Shift+G` si está trabajando con VS Code localmente) para ver cambios de git y realizar commits directamente en el editor.

![Panel de Control de Fuente](../../../en/docs/side_quests/img/source_control.png)
