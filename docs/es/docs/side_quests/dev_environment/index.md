...
Esta guía asume que ha completado el curso de capacitación [Hello Nextflow](../../hello_nextflow/index.md) y que está familiarizado con los conceptos fundamentales de Nextflow, incluyendo:
...
Intente buscar `container` en todo el espacio de trabajo:

![Búsqueda en el proyecto](../img/project_search.png)

Esto le muestra cada archivo que usa la directiva container, ayudándole a:

- Comprender qué procesos usan contenedores
...
- **[Hello nf-core](../../hello_nf-core/index.md)**: Construya pipelines de calidad de producción con estándares de la comunidad
