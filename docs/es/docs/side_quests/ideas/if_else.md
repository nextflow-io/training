...
### 1.2. Modificar tu pipeline de Nextflow para permitir que se ejecute en los modos `quote` y `sayHello`.
...
¡Celebra, toma un descanso para estirarte y bebe un poco de agua!
