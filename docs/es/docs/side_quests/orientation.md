...
El entorno de GitHub Codespaces contiene todo el software, código y datos necesarios para completar este curso de capacitación, por lo que no necesita instalar nada usted mismo.
