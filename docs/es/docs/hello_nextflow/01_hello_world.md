...
!!! note "Nota"
    ...
    Cubriremos esto en más detalle en la Parte 6 (Configuración).
...
Más generalmente, sabe cómo interpretar un workflow simple de Nextflow, gestionar su ejecución y recuperar salidas.
