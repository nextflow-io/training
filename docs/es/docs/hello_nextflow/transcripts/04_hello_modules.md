...
Voy a comenzar a trabajar en el archivo hello modules, que básicamente está donde lo dejamos al final del capítulo anterior. Tenemos nuestros tres procesos aquí. Tenemos un par de params, el bloque workflow, donde estamos ejecutando esos tres procesos y uniéndolos con canales. Luego publicamos los canales de salida y tenemos el bloque output diciendo cómo publicar esos archivos.
...
Así que hagámoslo ahora. Voy a crear rápidamente un nuevo archivo de módulo para el segundo proceso: convertToUpper.nf. Voy a cortar ese código, pegarlo ahí. Y luego voy a incluir ese. Genial.
...
Y también si mantengo presionado comando, estoy en una Mac, y hago clic en el nombre del proceso, abre el archivo directamente de inmediato. Lo trae. Así que puedo saltar directamente ahí sin siquiera pensar en cuáles son las rutas de archivo reales. Y eso funciona en cualquier lugar, puedo hacer eso también, donde sea que se estén llamando procesos. Así que eso lo hace realmente rápido.
