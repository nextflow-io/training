...
No queremos pasar los metadatos del archivo a la entrada. Queremos pasar el contenido de ese archivo. Si miramos el archivo _greetings.csv_, puedes ver aquí que tiene estas diferentes variables. _Hello, Bonjour, Hola_ de nuevo. Y estas son las cosas que realmente queremos estar pasando a nuestro proceso, no solo el archivo en sí como un solo objeto.
