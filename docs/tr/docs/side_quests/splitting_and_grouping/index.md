...
!!! note "Not"
    ...
    `Normal sample:` ve `Tumor sample:` satırlarının göreli sırası çalıştırmadan çalıştırmaya değişebilir; zira iki `view()` çağrısı eş zamanlı olarak yürütülen bağımsız kanallara aittir. Her etiket içindeki örneklerin sırası ise her zaman korunur.
