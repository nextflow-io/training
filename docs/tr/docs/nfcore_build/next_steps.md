...
Basit bir Nextflow iş akışını bir nf-core pipeline'ına dönüştürme göreviyle başladınız.
Bir şablon kullanarak pipeline iskeleti oluşturmayı ve mevcut pipeline'ı bu iskeleye yerleştirmeyi öğrendiniz.
Ardından yerel modüllerden birini bir nf-core modülü ile değiştirerek, diğer bir yerel modülü nf-core standartlarına uyacak şekilde dönüştürerek ve girdi doğrulaması ekleyerek pipeline'ı kademeli olarak geliştirdiniz.
...
Artık topluluk en iyi uygulamalarını takip eden, üretime hazır nf-core pipeline'ları oluşturmak için temel bilgiye sahipsiniz.

## Becerilerinizi geliştirmek için sonraki adımlar

Sırada ne yapabileceğinize dair en iyi 3 önerimiz:
