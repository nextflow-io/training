...
- :material-book-open-variant:{ .lg .middle } **Bireysel çalışma kursları**
...
- :material-information-outline:{ .lg .middle } **Ek bilgiler**
...
- :material-walk:{ .lg .middle } **Giriş seviyesi**
...
- :material-run:{ .lg .middle } **İleri seviye**
