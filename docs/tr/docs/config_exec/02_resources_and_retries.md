...
Kaynak tahmin etmenizin doğru olup olmadığından bağımsız olarak, bir görev başarısız olduğunda pipeline'ın otomatik olarak nasıl kurtarılacağını öğrenin.
