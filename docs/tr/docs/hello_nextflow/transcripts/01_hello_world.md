...
Ardından eşittir sembolü ve ardından buradaki varsayılan değer var. Nextflow başlangıçta Barselona'da yazıldı; bu yüzden burada biraz İspanyolca olması uygun görünüyor: varsayılan olarak _"Hola mundo!"_.

Tamam, o betiği kaydedeceğim, geri döneceğim, betiği _--input_ olmadan tekrar çalıştıracağım. Bu sefer çalışmalı ve _results_'ta yeni dosyamızı oluşturacak. Bu dosyada şimdi _"Hola mundo!"_ yazıyor.
