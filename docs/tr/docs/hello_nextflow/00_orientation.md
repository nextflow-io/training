...
Bu kursu kendi başınıza tamamlıyorsanız, lütfen daha fazla ayrıntı için [ortam temellerini](../envsetup/01_setup.md) inceleyin.
...
Varsayılan olarak, codespace tüm eğitim kurslarının kök dizininde çalışma dizini ayarlanmış olarak açılır, ancak bu kurs için `hello-nextflow/` dizininde çalışacağız.
