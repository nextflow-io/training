...
3. **İş akışını bir grup örnek üzerinde çalışacak şekilde uyarlayın.**
...
Nextflow'un veri akışı paradigmasından yararlanarak örnek başına işlemeyi birden fazla girdi örneği arasında paralelleştirmeyi biliyorsunuz.
