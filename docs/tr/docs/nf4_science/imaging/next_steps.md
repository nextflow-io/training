...
Nextflow for Bioimaging eğitimini tamamladığınız için tebrikler!
...
Nextflow bilginizi derinleştirmek için önerilen sonraki adımlar:

### Daha fazla nf-core pipeline'ı keşfedin

- **Tüm pipeline'lara göz atın**: [https://nf-co.re/pipelines](https://nf-co.re/pipelines)
...
- **[Nextflow Dokümantasyonu](https://www.nextflow.io/docs/latest/)**: Eksiksiz referans dokümantasyonu
- **[nf-core Dokümantasyonu](https://nf-co.re/docs)**: Kılavuzlar ve en iyi uygulamalar
