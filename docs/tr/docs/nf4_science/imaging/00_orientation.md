...
Eğer açmadıysanız, lütfen şimdi açın, tercihen bu talimatlara geri dönebilmeniz için ikinci bir tarayıcı penceresinde veya sekmesinde.
...
!!!warning "Makine boyutu gereksinimi"
    ...
    Bu eğitim kursu için Codespace'inizi oluştururken **8 çekirdekli bir makine** seçtiğinizden emin olun. Biyogörüntüleme iş akışları ek hesaplama kaynakları gerektirir.
...
Ancak, giriş yapmak için (ücretsiz) bir GitHub hesabına ihtiyacınız vardır ve arayüze aşina değilseniz, [GitHub Codespaces Yönlendirme](../../envsetup/index.md) mini-kursunu tamamlayarak birkaç dakikanızı ayırıp arayüze alışmalısınız.
...
Bu çalışırken yönlendirmenin geri kalanına devam edebilirsiniz.

!!!tip

    `-stub` bayrağı, pipeline'ın gerçek veri işlemeden hızlı bir şekilde çalışmasını sağlar, bu da imajları indirmek için mükemmeldir. Terminal sekmesinde ilerlemeyi izleyebilirsiniz.
...
!!!tip
    ...
    Herhangi bir nedenle bu dizinden çıkarsanız, GitHub Codespaces eğitim ortamında çalıştığınızı varsayarak, tam yolu kullanarak her zaman geri dönebilirsiniz:
