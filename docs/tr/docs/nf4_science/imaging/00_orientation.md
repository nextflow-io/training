...
Ancak giriş yapmak için (ücretsiz) bir GitHub hesabına ihtiyacınız var. Arayüze aşina değilseniz, [GitHub Codespaces Yönlendirmesi](../../envsetup/index.md) mini kursunu tamamlayarak birkaç dakikanızı ayırıp arayüze alışmalısınız.
