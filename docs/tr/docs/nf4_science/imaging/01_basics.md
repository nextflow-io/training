...
- Üretimde bir pipeline çalıştırıyorsanız ve bir şeyler ters giderse, çoğu durumda sorunu düzeltebilir ve pipeline'ı yeniden başlatabilirsiniz; pipeline başarısızlık noktasından çalışmaya devam edecektir, bu da size çok fazla zaman ve hesaplama tasarrufu sağlayabilir.
