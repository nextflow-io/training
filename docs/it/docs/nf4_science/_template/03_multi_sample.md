...
Ora la estenderemo per implementare {AGGREGATION_METHOD} multi-campione, come trattato nella [Parte 1](01_method.md).
...
Richiamiamo il comando modificato dalla [Parte 1](01_method.md):
