...
Possiamo eseguirlo con `-profile test` per utilizzare il valore predefinito configurato nel profilo di test ed evitare di dover scrivere il percorso sulla riga di comando.
