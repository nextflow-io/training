...
- **La directory `modules`** contiene file di modulo scheletro che compilerete durante il corso.
...
- **La directory `solutions`** contiene file di modulo completati e soluzioni specifiche per parte che possono servire come punto di partenza per la parte successiva.
