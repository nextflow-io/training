...
Potete impostare VSCode per concentrarsi su questa directory, in modo che solo i file rilevanti vengano visualizzati nella barra laterale dell'esploratore file:
