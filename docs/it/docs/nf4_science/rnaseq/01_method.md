...
Questo conclude il test di elaborazione del singolo campione.
...
L'output principale è il report `all_samples_QC.html`, accompagnato da una directory data contenente le metriche sottostanti.

#### 2.3.4. Spostare i file di output

Spostate il report e la sua directory data sul filesystem montato.
