...
- Inizia con nf-core con [Build with nf-core](../hello_nf-core/index.md)
- Impara tecniche di troubleshooting con la [Debugging Side Quest](../side_quests/debugging/index.md)
