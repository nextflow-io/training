...
- :material-book-open-variant:{ .lg .middle } **Corsi self-service**
...
- :material-information-outline:{ .lg .middle } **Informazioni aggiuntive**
...
- :material-walk:{ .lg .middle } **Percorso introduttivo**
...
- :material-run:{ .lg .middle } **Percorso avanzato**
