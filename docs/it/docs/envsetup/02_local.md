...
!!! tip "Suggerimento"
    ...
    Prima di procedere, avete considerato l'utilizzo dell'[approccio Devcontainers](03_devcontainer.md)?
...
In totale, dovrete avere installato il seguente software:
...
Per lavorare attraverso un corso, aprite una finestra del terminale (idealmente, dall'interno dell'applicazione VSCode) e fate `cd` nella directory pertinente.
