...
Infine, Le raccomandiamo di dare un'occhiata a [**Seqera Platform**](https://seqera.io/), una piattaforma basata su cloud sviluppata dai creatori di Nextflow che rende ancora più facile lanciare e gestire i suoi workflow, oltre a gestire i suoi dati ed eseguire analisi in modo interattivo in qualsiasi ambiente.
