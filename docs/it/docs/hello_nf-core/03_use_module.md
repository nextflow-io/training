...
In questa terza parte del corso di formazione Build with nf-core, mostreremo come trovare, installare e utilizzare un modulo nf-core esistente nella propria pipeline.
