...
Andate a dare un'occhiata e se ci sono cose diverse che potrebbero essere rilevanti per il vostro lavoro, come nf-test o fare cose diverse con i metadati e pattern di scripting comuni, controllate i Side Quests e vedete se potrebbe essere utile per approfondire.

C'è anche il corso su nf-core. Speriamo che a questo punto abbiate familiarità con il progetto, ma se non lo conoscete, andate a dare un'occhiata. Ci sono quasi 150 pipeline diverse per diversi tipi di analisi e diversi tipi di dati, quindi è del tutto possibile che ci sia una pipeline pronta all'uso per il tipo di analisi dati di cui avete bisogno.
...
Okay. Andando avanti. Se avete mai bisogno di supporto con Nextflow, controllate community.seqera.io. È davvero attivo e speriamo di vedervi lì per discutere i vostri diversi problemi e casi d'uso, e forse ora potete anche aiutare altre persone.

Abbiamo anche molti eventi in corso. Abbiamo eventi della community provenienti da nf-core e Nextflow. Abbiamo un hackathon nf-core online e distribuito a marzo, l'anno scorso si sono unite oltre mille persone con sedi in tutto il mondo. Quindi unitevi a noi se potete.
...
Se volete rimanere aggiornati sulle cose che accadono nell'ecosistema Nextflow, controllate seqera.io/blog.
...
Vorrei anche fare pubblicità al mio progetto personale, che è il Nextflow Podcast. Controllatelo su Spotify, o Apple Music, o YouTube. Pubblichiamo nuovi episodi periodicamente dove chiacchiero con altre persone, che lavorano con Nextflow o tecnologie associate, o persone nella community. E facciamo approfondimenti tecnici reali su come funzionano le cose e cosa stanno facendo le persone. Quindi se siete interessati, controllateli. Sono davvero divertenti.
...
Ancora una volta, molte, molte grazie per esservi uniti a noi in questo corso, e in questo viaggio. Aprite una issue GitHub o una Pull Request se avete notato qualcosa nel materiale di formazione che pensate possa essere migliorato. E spero davvero di vedervi in un altro corso di formazione Nextflow, o forse a un hackathon o a un evento. Grazie ancora.​
