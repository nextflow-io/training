...
Completare questi esercizi _non è necessario_ per comprendere le parti successive della formazione, ma forniscono un modo divertente per consolidare le vostre conoscenze cercando di far citare alla mucca scienziati famosi.
