...
=== "Dopo"
    ...
    ```groovy title="main.nf" linenums="7" hl_lines="1-2"
        // Carica file con channel.fromFilePairs
...
```groovy title="modules/analyze_reads.nf - esempio di processo" linenums="1"
#!/usr/bin/env nextflow
