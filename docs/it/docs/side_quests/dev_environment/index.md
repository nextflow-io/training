...
Questa guida presuppone che abbiate completato il corso di formazione [Hello Nextflow](../../hello_nextflow/index.md) e che abbiate familiarità con i concetti fondamentali di Nextflow, tra cui:
...
!!! info "Perché le funzionalità dell'IDE adesso?"
    ...
    Probabilmente avete già utilizzato VS Code durante il corso [Hello Nextflow](../../hello_nextflow/index.md), ma abbiamo mantenuto il focus sull'apprendimento dei fondamentali di Nextflow piuttosto che sulle funzionalità dell'IDE. Ora che avete familiarità con i concetti di base di Nextflow come processi, flussi di lavoro, canali e moduli, siete pronti a sfruttare le sofisticate funzionalità dell'IDE che vi renderanno sviluppatori più efficienti.
...
Provate a cercare `container` nell'intero workspace:

![Ricerca nel progetto](../img/project_search.png)

Questo vi mostra ogni file che utilizza la direttiva container, aiutandovi a:

- Capire quali processi utilizzano container
...
- **[nf-test](../nf_test/index.md)**: Create suite di test complete per i vostri flussi di lavoro
- **[Build with nf-core](../../hello_nf-core/index.md)**: Costruite pipeline di qualità produttiva con gli standard della community
