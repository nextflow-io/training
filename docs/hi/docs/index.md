---
title: होम
description: Nextflow कम्युनिटी ट्रेनिंग पोर्टल पर आपका स्वागत है!
hide:
  - toc
  - footer
---
...
-   :material-book-open-variant:{ .lg .middle } __स्व-सेवा कोर्स__
    ...
    **Nextflow कम्युनिटी ट्रेनिंग पोर्टल पर आपका स्वागत है!**
...
-   :material-account-group-outline:{ .lg .middle } __प्रशिक्षण इवेंट__
    ...
    **स्व-सेवा से परे कुछ खोज रहे हो?**
...
-   :material-account:{ .lg .middle } __उपयोगकर्ताओं के लिए__
    ...
    ??? courses "**Use nf-core:** कम्युनिटी-क्यूरेटेड पाइपलाइन खोजो और चलाओ"

        nf-core कम्युनिटी प्रोजेक्ट से पाइपलाइन खोजने, चलाने और कॉन्फ़िगर करने का एक तेज़ परिचय, एक छोटी डेमो पाइपलाइन से शुरू करके प्रोडक्शन-स्केल विश्लेषण पाइपलाइन तक।
    ...
    ??? courses "**Configure Execution:** संसाधन, retries और execution प्रोफ़ाइल कॉन्फ़िगर करो"

        Nextflow पाइपलाइन execution कॉन्फ़िगर करने का एक व्यावहारिक परिचय: अलग-अलग कंप्यूट वातावरण के अनुकूल होना, संसाधन आवंटन और retries नियंत्रित करना, और पूर्व-निर्धारित कॉन्फ़िगरेशन प्रोफ़ाइल के बीच स्विच करना।

        [प्रशिक्षण देखो :material-arrow-right:](config_exec/index.md){ .md-button .md-button--secondary }
...
-   :material-code-tags:{ .lg .middle } __डेवलपर्स के लिए__
    ...
    ??? catalog "**Side Quests:** Nextflow के उन्नत विषयों में गहराई से जाओ"
        ...
        स्वतंत्र मिनी-कोर्स का एक संग्रह जो उन Nextflow डेवलपर्स के लिए है जो अपनी क्षमताओं का विस्तार करना और/या विशेष विषयों पर अपने कौशल को गहरा करना चाहते हैं।
...
-   :material-lifebuoy:{ .lg .middle } __सहायता प्राप्त करो__

    ---

    Nextflow प्रशिक्षण में समस्या होने पर उपयोगी संसाधन।

    [सहायता खोजो :material-arrow-right:](help.md){ .md-button .md-button--secondary }
