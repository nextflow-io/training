...
!!! tip "सुझाव"
    ...
    अधिक details के लिए, Side Quest [Working with Files](../side_quests/working_with_files/index.md) देखो।
...
Nextflow किसी भी conflicts को resolve करने के लिए set [order of precedence](https://nextflow.io/docs/latest/config.html#configuration-file) apply करता है, लेकिन यह खुद determine करना tricky हो सकता है।
...
अधिक जानें: [1.1. `nextflow.config` में values set up करें](#11-set-up-values-in-nextflowconfig)
</quiz>
...
अधिक जानें: [1.3. Parameter फ़ाइल use करें](#13-use-a-parameter-file)
</quiz>
...
अधिक जानें: [2.1. `outputDir` directory name customize करो](#21-customize-the-outputdir-directory-name)
</quiz>
...
अधिक जानें: [2.2. Process के अनुसार outputs organize करो](#22-organize-outputs-by-process)
</quiz>
...
अधिक जानें: [3. Software packaging technology select करें](#3-select-a-software-packaging-technology)
</quiz>
...
अधिक जानें: [4. Execution platform select करें](#4-select-an-execution-platform)
</quiz>
...
अधिक जानें: [5.1. Resource utilization report generate करने के लिए workflow run करो](#51-run-the-workflow-to-generate-a-resource-utilization-report)
</quiz>
...
अधिक जानें: [5.3. Specific process के लिए resource allocations set करो](#53-set-resource-allocations-for-a-specific-process)
</quiz>
...
अधिक जानें: [5.5. Resource limits add करो](#55-add-resource-limits)
</quiz>
...
अधिक जानें: [6. Preset configurations के बीच switch करने के लिए profiles use करें](#6-use-profiles-to-switch-between-preset-configurations)
</quiz>
...
अधिक जानें: [6.3. Resolved configuration देखने के लिए `nextflow config` use करो](#63-use-nextflow-config-to-see-the-resolved-configuration)
</quiz>
