...
और जानें: [4.1. `-resume` के साथ workflow फिर से लॉन्च करो](#41-re-launch-a-workflow-with--resume)
</quiz>
...
और जानें: [4.2. पिछले executions के log का निरीक्षण करो](#42-inspect-the-log-of-past-executions)
</quiz>
...
और जानें: [3.4. कमांड-लाइन parameters की params system](#34-the-params-system-of-command-line-parameters)
</quiz>
...
और जानें: [3.5. publish directive](#35-the-publish-directive)
</quiz>
...
और जानें: [4.3. पुरानी work directories delete करो](#43-delete-older-work-directories)
</quiz>
