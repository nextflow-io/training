...
??? info "इस खंड से कैसे शुरू करें"
    ...
    यह खंड मानता है कि आपने [भाग 3: nf-core मॉड्यूल बनाएं](./03_make_module.md) पूरा कर लिया है और अपने pipeline में `COWPY` प्रोसेस मॉड्यूल को nf-core मानकों के अनुसार अपडेट कर दिया है।

    यदि आपने भाग 3 पूरा नहीं किया है या इस भाग के लिए नई शुरुआत करना चाहते हैं, तो आप अपने प्रारंभिक बिंदु के रूप में `core-hello-part3` समाधान का उपयोग कर सकते हैं।
...
यदि तुम्हारी नज़र तेज़ है, तो तुम देख सकते हो कि जिस `batch` इनपुट पैरामीटर का हम उपयोग कर रहे हैं वह अभी तक स्कीमा में परिभाषित नहीं है।
...
??? info "स्कीमा पैरामीटर कहां से आते हैं?"
    ...
    तुम्हारी workflow स्क्रिप्ट में कहीं और घोषित पैरामीटर (जैसे `main.nf` या मॉड्यूल फ़ाइलों में) स्कीमा validator द्वारा स्वचालित रूप से **नहीं** उठाए जाते हैं।

    इसका मतलब है कि तुम्हें हमेशा अपने pipeline पैरामीटर `nextflow.config` में घोषित करने चाहिए, और फिर उनके सत्यापन नियम `nextflow_schema.json` में परिभाषित करने चाहिए।
...
जब तुम समाप्त कर लो, तो शीर्ष दाएं कोने में **"Finished"** बटन पर क्लिक करें।

अपने टर्मिनल में वापस, तुम देखोगे:
...
1. **`#!groovy samplesheetToList(params.input, "${projectDir}/assets/schema_input.json")`**: इनपुट फ़ाइल को हमारी स्कीमा के विरुद्ध सत्यापित करता है और एक list लौटाता है
...
यदि तुम इसका अभ्यास करना चाहते हो, तो अन्य greetings इनपुट फ़ाइलें बनाने के लिए स्वतंत्र महसूस करो जो स्कीमा का अन्य मज़ेदार तरीकों से उल्लंघन करती हैं।

### सारांश

तुमने पैरामीटर सत्यापन और इनपुट डेटा सत्यापन दोनों को लागू और परीक्षण किया है। तुम्हारा pipeline अब निष्पादन से पहले इनपुट को सत्यापित करता है, त्वरित फीडबैक और स्पष्ट त्रुटि संदेश प्रदान करता है।
...
तुमने Build with nf-core प्रशिक्षण कोर्स के सभी पांच भाग पूरे कर लिए हैं!

तुमने क्या बनाया है और सीखा है, इस पर विचार करने के लिए [सारांश](next_steps.md) पर जारी रखो।
