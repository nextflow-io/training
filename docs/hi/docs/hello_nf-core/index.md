...
| --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| [भाग 1: Run a demo pipeline](./01_run_demo.md)            | एक मौजूदा nf-core पाइपलाइन चलाएँ और इसकी कोड संरचना की जांच करें ताकि यह समझ सकें कि ये पाइपलाइन बुनियादी Nextflow वर्कफ़्लो से कैसे अलग हैं                     | 30 मिनट       |
| [भाग 2: Rewrite Hello for nf-core](./02_rewrite_hello.md) | एक मौजूदा वर्कफ़्लो को nf-core टेम्पलेट स्कैफोल्ड में अनुकूलित करें, [Hello Nextflow](../hello_nextflow/index.md) कोर्स में तैयार सरल वर्कफ़्लो से शुरू करते हुए | 60 मिनट       |
| [भाग 3: Use an nf-core module](./03_use_module.md)        | समुदाय मॉड्यूल लाइब्रेरी का अन्वेषण करें और पूर्व-निर्मित, परीक्षित मॉड्यूल को एकीकृत करना सीखें जो सामान्य बायोइंफॉर्मेटिक्स टूल को रैप करते हैं                | 30 मिनट       |
| [भाग 4: Make an nf-core module](./04_make_module.md)      | nf-core द्वारा स्थापित विशिष्ट संरचना, नामकरण परंपराओं और मेटाडेटा आवश्यकताओं का उपयोग करके अपना स्वयं का nf-core-शैली का मॉड्यूल बनाएँ                          | 30 मिनट       |
