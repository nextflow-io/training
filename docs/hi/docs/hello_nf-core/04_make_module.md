...
!!! note "नोट"
    ...
    इसमें अभी केवल `CAT_CAT` से version जानकारी है, क्योंकि `COWPY` अभी अपना version रिपोर्ट नहीं करता।
...
- Actual `cowpy` command भरें जो `$args` और `${prefix}.txt` दोनों का उपयोग करता है
