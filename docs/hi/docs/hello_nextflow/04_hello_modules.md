...
यह हमारे कोड को अधिक शेयर करने योग्य, लचीला और रखरखाव योग्य बनाएगा।
...
यह इस ट्रेनिंग कोर्स के भाग 3 के माध्यम से काम करके बनाई गई स्क्रिप्ट के बराबर है, सिवाय इसके कि हमने आउटपुट डेस्टिनेशन बदल दिए हैं:
...
हम module के लिए एक फ़ाइल stub बनाने जा रहे हैं, संबंधित कोड को कॉपी करेंगे फिर इसे मुख्य वर्कफ़्लो फ़ाइल से हटा देंगे।

फिर हमें बस एक `include` स्टेटमेंट जोड़ना होगा ताकि Nextflow को पता चले कि runtime पर संबंधित कोड को pull करना है।
...
यह हमें process कोड डालने के लिए एक जगह देता है।
...
चलो इसे `params` ब्लॉक के ऊपर insert करते हैं और इसे उचित रूप से भरते हैं।
...
हम पहले की तरह अनिवार्य रूप से समान कोड और inputs के साथ वर्कफ़्लो चला रहे हैं, तो चलो `-resume` फ्लैग के साथ चलाते हैं और देखते हैं कि क्या होता है।
...
अधिक modules बनाने का अभ्यास करो।
...
/*
 * greeting को uppercase में बदलने के लिए एक text replacement tool का उपयोग करें
 */
...
मज़ाक को एक तरफ रखते हुए, अब तुम्हारा कोड अधिक modular है, और अगर तुम कोई अन्य पाइपलाइन लिखने का निर्णय लेते हो जो उन processes में से किसी एक को call करती है, तो तुम्हें संबंधित module का उपयोग करने के लिए बस एक छोटा `include` स्टेटमेंट टाइप करना होगा।
यह कोड को copy-paste करने से बेहतर है, क्योंकि अगर बाद में तुम module को बेहतर बनाने का निर्णय लेते हो, तो तुम्हारी सभी पाइपलाइनें सुधारों को inherit करेंगी।

### आगे क्या है?

अगर तुम्हें ऐसा लगता है तो थोड़ा ब्रेक लो।

जब तुम तैयार हो, तो सॉफ़्टवेयर dependencies को अधिक सुविधाजनक और reproducibly प्रबंधित करने के लिए containers का उपयोग करना सीखने के लिए [**भाग 5: Hello Containers**](./05_hello_containers.md) पर जाएँ।
...
<quiz>
modules का उपयोग करने के क्या लाभ हैं? (सभी लागू का चयन करें)
- [x] वर्कफ़्लो में कोड की पुनः उपयोगिता
- [x] आसान रखरखाव
- [x] वर्कफ़्लो कोड का बेहतर संगठन
- [ ] तेज़ execution स्पीड
</quiz>
