...
- [x] एक standalone file जो process definitions contain कर सकती है
- [ ] एक workflow definition
- [ ] एक channel operator

और जानें: [2. `sayHello()` के लिए module बनाएं](#2-create-a-module-for-sayhello)
</quiz>
...
और जानें: [1. Modules store करने के लिए directory बनाएं](#1-create-a-directory-to-store-modules)
</quiz>
...
और जानें: [2.3. Workflow block से पहले include declaration add करें](#23-add-an-include-declaration-before-the-workflow-block)
</quiz>
