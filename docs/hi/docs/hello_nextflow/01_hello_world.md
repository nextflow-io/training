...
Process name या अन्य variables का उपयोग करके results को organize करने के लिए उपयोग की जाने वाली directories को name करना भी संभव है, और top-level output directory का default name बदलना संभव है (जो special variable `outputDir` द्वारा controlled है)।
हम इन options को later trainings में cover करेंगे।
