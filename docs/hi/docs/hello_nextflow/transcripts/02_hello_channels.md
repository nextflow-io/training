...
यहां यह कहता है: हमने echo रन करने की कोशिश की, लेकिन इस CSV फ़ाइल की contents को echo करने के बजाय, इसने बस path को echo किया। और तुम देख सकते हो कि यह इस CSV फ़ाइल का पूरा absolute path यहां है।
