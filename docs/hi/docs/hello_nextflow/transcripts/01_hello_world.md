...
फिर उसके बाद हमारे पास एक equal symbol है और फिर यहां default value है। Nextflow मूल रूप से Barcelona में लिखा गया था, तो यह उपयुक्त लगता है कि हमारे पास यहां कुछ, Spanish है, _"Hola mundo!"_ एक default के रूप में।

ठीक है मैं उस script को save करने जा रहा हूं, वापस जाओ, script को फिर से _--input_ के बिना चलाओ। और इस बार यह चलना चाहिए और यह _results_ में हमारी नई फ़ाइल बनाएगा। और इस फ़ाइल में अब यह _"Hola mundo!"_ कहता है।
