...
तो चलो वास्तव में सरल शुरू करते हैं। चलो बस "echo" से शुरू करते हैं, terminal में कुछ प्रिंट करने के लिए। "Hello World"। मैं enter दबाता हूं और वह terminal में जाता है। Hello World। उम्मीद है कि यह इस कोर्स को देख रहे किसी के लिए आश्चर्य की बात नहीं है।

ठीक है, चलो इसके साथ कुछ करते हैं। इसे सिर्फ terminal में प्रिंट करने के बजाय, चलो इसे एक फ़ाइल में लिखते हैं। मैं अपने keyboard के up cursor को दबाने जा रहा हूं, जो Bash history के माध्यम से cycle करता है, तो यह मुझे मेरा आखिरी command देता है, और मैं इसके अंत में वहां जोड़ने जा रहा हूं, छोटा greater than symbol, जो इस command से output को एक फ़ाइल में redirect करता है, और मैं इसे output.txt कहने जा रहा हूं।
...
ठीक है। और फिर नीचे हमारे पास यहां एक workflow है, और फिर से, हमारे पास एक declaration है। इसे Main कहा जाता है। यह workflow का समकक्ष है एक script block का, अगर तुम चाहो। यह workflow का वह हिस्सा है जो कुछ करता है। और इस मामले में, हम कह रहे हैं, sayHello नामक process को call करो।
...
ठीक है, इसे शीर्ष पर कुछ standard चीजें मिली हैं, जो हमें बताती हैं कि Nextflow चला और कौन सा version चल रहा था और script का नाम और सब कुछ क्या था।

और वास्तव में महत्वपूर्ण चीज़ जिसे हम यहां ढूंढ रहे हैं वह _यहां_ है, जो विभिन्न tasks का सारांश है जो execute किए गए थे।

अगर तुम्हारा इस तरह दिखता है एक छोटे हरे tick के साथ, तो बहुत बढ़िया। तुमने अभी-अभी अपनी पहली pipeline चलाई है। शानदार।

यह हमें यहां process का नाम बताता है, जो चला, जिसे Say Hello कहा जाता था, और इसने हमें बताया कि यह एक बार चला और यह सफल रहा। यह जैसे-जैसे तुम आगे बढ़ते हो update होता है, तो जब तुम एक बड़ी pipeline चला रहे होते हो, तुम यहां progress को represented देखोगे। लेकिन क्योंकि यह इतना छोटा है, यह मूल रूप से तुरंत चलता है।

## 1.2.2. work directory में output और logs खोजें

अब जब तुम एक Nextflow pipeline चलाते हो, उन processes में से प्रत्येक को एक साथ जोड़ा जाता है, और प्रत्येक process, जैसा कि मैंने पहले कहा, tasks उत्पन्न कर सकती है एक या कई। तो इस मामले में, हमारे पास इस process से एक single task था। यह बस एक बार चला और वह इस task _hash_ के तहत किया गया था।
...
जब मैं उन फ़ाइलों को list करता हूं, तो तुम output.txt फ़ाइल को generated देख सकते हो। तुम इसे यहां भी देख सकते हो। और कुछ hidden फ़ाइलें हैं, जो मेरे regular "ls" के साथ नहीं दिख रही हैं।

अगर मैं output.txt पर click करता हूं, तो निश्चित रूप से, हमारे पास हमारा output है। शानदार। तो pipeline काम कर गई।

यह जो मूल रूप से एक one line bash script थी उसे चलाने के लिए काफी boilerplate लग सकता है, लेकिन जैसे-जैसे हमारी processes अधिक जटिल होती जाएंगी यह अधिक समझ में आएगा। और Nextflow के साथ यह work directory और ये फ़ाइलें, जो बनाई जाती हैं, वास्तव में वह रीढ़ है जो Nextflow को इतना शक्तिशाली बनाती है।
...
चलो work directory में इन अन्य फ़ाइलों पर एक त्वरित नज़र डालते हैं। ऊपर से नीचे तक, हमारे पास _.command.begin_ नामक एक फ़ाइल है। यह खाली है। यह बस एक sentinel फ़ाइल है, जो Nextflow द्वारा बनाई गई है जो कहती है, ठीक है, मैं task शुरू कर रहा हूं। वहां कुछ भी दिलचस्प नहीं है।
...
आम तौर पर, तुम्हें वास्तव में कभी भी इस फ़ाइल को देखने की आवश्यकता नहीं है। यह Nextflow द्वारा autogenerated है और इसमें तुम्हारी pipeline के लिए विशेष रूप से कुछ भी नहीं है। लेकिन वह वास्तव में वह core है जो चल रहा है।
...
ठीक है, यह Nextflow के लिए अपने आप में बहुत अच्छा है, जबकि यह तुम्हारी pipeline चला रहा है ताकि सभी चीजें एक दूसरे से अलग हों और clean हों और managed की जा सकें।

लेकिन यह बहुत उपयोगी नहीं है अगर तुम एक व्यक्ति हो जो अपने results को explore करने की कोशिश कर रहे हो। तुम वास्तव में हजारों और हजारों अलग-अलग work directories के माध्यम से अपनी result फ़ाइलों को खोजने की कोशिश नहीं करना चाहते। और तुम वास्तव में ऐसा करने के लिए नहीं हो। work directories का मतलब यह नहीं है कि वे तुम्हारी फ़ाइलों के बनाए जाने की अंतिम स्थिति हों।

हम अपनी फ़ाइलों को publish करके ऐसा करते हैं।

## 2.1.1. sayHello प्रोसेस के output को declare करें
...
मैंने गलती से वहां एक typo बनाया, लेकिन यह Nextflow VS Code extension की कुछ features को भी इंगित करने का एक अच्छा अवसर है। तुम देख सकते हो कि तुरंत इसने मुझे इसके नीचे एक छोटी wiggly red line दी जो कहती है कि कुछ गलत है। और अगर मैं इसके ऊपर hover करता हूं, तो यह मुझे बताने जा रहा है कि यह variable defined नहीं है। मुझे नहीं पता कि यह क्या है।

इस मामले में यह बहुत स्पष्ट है, मैंने एक typo बनाया। मेरा मतलब sayHello टाइप करना था, और फिर squiggly line चली जाती है।

अब यह purple है। Nextflow syntax parser जानता है कि यह एक process है और जब मैं इसके ऊपर hover करता हूं, तो यह मुझे एक reduced representation देता है कि यह process कैसी दिखती है। तो मैं बहुत जल्दी एक नज़र में देख सकता हूं कि यह कोई inputs नहीं लेती है और यह हमें यह output देती है। तो VS Code में इस extension के साथ काम करना तुम्हें code लिखते समय बहुत सारी contextual information देता है।

ध्यान दें कि हम _.out_ syntax के साथ इस process से output को refer कर सकते हैं। और इस समय हम इसे जो चाहें कह सकते हैं, यह सिर्फ एक arbitrary variable name है।

## 2.1.2. script में एक output: block जोड़ें

जहां यह महत्वपूर्ण हो जाता है वह तब है जब हम यहां अपना नया block करते हैं, और यह अब workflow block के नीचे है, हम अब workflow के अंदर नहीं हैं। फिर से squiggly brackets। और यह वह जगह है जहां हम बस Nextflow को बताते हैं कि सभी फ़ाइलों को कहां रखना है, जो workflow द्वारा बनाई गई हैं।

अब मैं इस variable name को लेने जा रहा हूं, जो मैंने यहां बनाया था, और मैं इसे वहां रखने जा रहा हूं और इसके लिए कुछ squiggly brackets डालूंगा। और मैं Nextflow को path का उपयोग करने के लिए कहने जा रहा हूं। ओह। Path, quote marks में। और मैं dot का उपयोग करने जा रहा हूं। यह बस Nextflow को results directory के root में फ़ाइल डालने के लिए कहता है। तो कोई sub directories या कुछ भी नहीं।
...
"Results" इस path के लिए default name है। अगर मैं workflow को फिर से चलाता हूं, और इस बार मैं _dash_ single hyphen करता हूं, यह है, क्योंकि यह एक core Nextflow option है। _"-Output-dir **my** results"_। _"-o"_ भी कर सकता था short के लिए। फिर यह एक अलग base directory सेट करने जा रहा है जहां फ़ाइलें stored हैं और एक बार फिर, यहां _myresults/_ में, अब हमारे पास एक _output.txt_ है।
...
## 3.1. sayHello प्रोसेस को एक variable input की उम्मीद करने के लिए बदलें
...
सबसे पहले, हमें इस process को बताने की आवश्यकता है कि यह एक input variable को accept कर सकती है और हम यहां एक नए declaration block के रूप में _input_ टाइप करते हैं। और हम इसे _"val greeting"_ कहने जा रहे हैं।

val bit यहां नीचे path के बराबर है। यह Nextflow को बताता है कि यह एक variable है, इस मामले में एक string की तरह। और अगर तुम इसके ऊपर फिर से hover करते हो, तो यह तुम्हें extension से बताता है कि इसका क्या मतलब है।
...
मैं इसे जो चाहूं कह सकता हूं, मैं इसे _hello, greeting_ कह सकता हूं। कोई फर्क नहीं पड़ता। मैं वहां जो भी करूंगा वह एक CLI option के रूप में exposed होगा जब हम एक pipeline launch करते हैं। और यह Nextflow द्वारा एक real magic trick है क्योंकि इसका मतलब है कि तुम इन parameters के साथ अपनी workflow script को बहुत जल्दी build कर सकते हो, और तुम अनिवार्य रूप से अपनी pipeline के लिए एक custom CLI बना रहे हो, जिससे यह वास्तव में आसान हो जाता है कि जब तुम launch करते हो तो on the fly विभिन्न options को customize करना।

तो। चलो इसे try करते हैं। अपने terminal पर वापस जाओ। हमारे पास यहां हमारा _"nextflow run"_ command है। और अब मैं _"--input"_ करने जा रहा हूं, जो _"params.input"_ से मेल खाता है जो हमने पहले देखा था। मुझे लगता है कि docs में यह French में है। Geraldine को French बोलना पसंद है। मैं इसे Swedish में करने जा रहा हूं क्योंकि मैं Sweden में रहता हूं। तो मैं कहने जा रहा हूं, "_Hej Världen_" और enter hit करूंगा।
...
तो हमने dynamically एक CLI से एक parameter को एक input pass किया है। हमने उसे process को एक input के रूप में pass किया है और process ने उसे interpret किया और इसे एक script block में डाला, जिसने फिर dynamically उस script result के output को बदल दिया। बहुत cool।

यहां बहुत कम syntax के साथ काफी complex logic। और तुम उम्मीद कर सकते हो कि यह अब कैसे scale होना शुरू होता है। और यह वह तरीका है जिससे हम वास्तव में अपनी pipelines की logic और customizability को Nextflow script में build करते हैं।
...
तुम notice करोगे कि जब हमने यह लिखा, तो हमने बस _params.input_ को सीधे वहां डाला जहां हम इसका उपयोग कर रहे हैं। तो obvious solution यह है कि हम एक default define करते हैं, और हम workflow में यहां script के शीर्ष पर एक विशेष params block में ऐसा करते हैं। यह यहां workflow script में है।
...
और तुम अपनी script में इस काफी अच्छी symmetry के साथ समाप्त होते हो, जहां तुम्हारे पास effectively यहां तुम्हारे सभी workflow inputs हैं और नीचे तुम्हारे workflow outputs हैं। और यह बहुत स्पष्ट है कि बाहरी दुनिया के लिए तुम्हारी workflow का interface क्या है। तो तुम नए syntax के साथ एक नई pipeline को बहुत जल्दी pick up कर सकते हो और समझ सकते हो कि इसका उपयोग कैसे करना है।
...
अगर तुम curious हो, वैसे, ये सभी adjectives और scientists names Nextflow source code में हैं। यह Nextflow को अपना पहला ever pull request प्राप्त करने का एक वास्तव में अच्छा तरीका है जाकर इसे ढूंढकर और अपने पसंदीदा scientists को जोड़कर।
...
अगर कभी तुम भूल जाते हो कि ये flags हर Nextflow command के लिए क्या हैं तो तुम _"nextflow help"_ कर सकते हो, और फिर command का नाम। तो अगर मैं _"nextflow help clean"_ करता हूं, तो तुम सभी अलग-अलग options देख सकते हो: _-after, -before, -but_, इस cleanup behavior को configure करने के सभी अलग-अलग तरीके। बहुत cool।

## सारांश

ठीक है, यह Hello Nextflow के भाग एक का अंत है। यह कोर्स की काफी intense शुरुआत है, लेकिन उम्मीद है कि अब तुम्हें एक Nextflow script कैसी दिखती है इसकी काफी अच्छी समझ है; अलग-अलग key parts के साथ, processes, workflows, outputs, और parameters। तुम जानते हो कि उन्हें command line से basic overrides के साथ कैसे configure करना है, dynamic input block को dynamic script के साथ कैसे बनाना है और तुम जानते हो कि अपने सभी workload executions को कैसे manage करना है: देखना कि तुमने पहले क्या चलाया है, resuming, cleaning up। बहुत सारी चीजें हैं। तुम एक लंबा रास्ता तय कर चुके हो। तो अगर तुम break लेना चाहते हो और एक quick walk around और एक cup of tea लेना चाहते हो, तो अब शायद एक अच्छा समय है। तुमने इसे earned किया है।
...
अब अगर तुम webpage पर भाग एक, hello world तक scroll करते हो तो तुम एक छोटा quiz देखोगे और यह कुछ नया है जो हमने Nextflow training के इस version के लिए किया है। और तुम जा सकते हो और खुद को quiz कर सकते हो यह check करने के लिए कि तुमने इस अध्याय में हमने जो सभी material किया है उसे समझा है या नहीं।

यह हमें भेजा नहीं जाता या कुछ भी नहीं, यह बस तुम्हारे browser में stored है। तो हम नहीं जानते कि तुम्हारे answers क्या हैं, लेकिन यह बस एक छोटा self check है यह सुनिश्चित करने के लिए कि तुमने कुछ भी miss नहीं किया है या कुछ भी misunderstood नहीं किया है। और तुम इसे जितनी बार चाहो try कर सकते हो।
...
Cool। ठीक है। उम्मीद है कि तुम्हें वह enjoy आया। थोड़ा fun करो और, हम तुम्हें अगले अध्याय में बस एक मिनट में देखेंगे Nextflow channels के बारे में बात करने के लिए।
