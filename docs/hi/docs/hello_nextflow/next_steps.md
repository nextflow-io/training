...
/// caption
:fontawesome-brands-youtube:{ .youtube } [Nextflow YouTube channel पर पूरी playlist](https://youtube.com/playlist?list=PLPZ8WHdZGxmWKozQuzr27jyMGqp9kElVK&si=eF7cLR62goy-lc6n) देखो।
...
- [Hello nf-core](../hello_nf-core/index.md) के साथ nf-core शुरू करो
- [Side Quests](../side_quests/index.md) के साथ more advanced Nextflow features explore करो
