...
भाग 2 में, तुमने एक per-sample प्रोसेसिंग पाइपलाइन बनाई थी जो हर सैंपल को स्वतंत्र रूप से हैंडल करती थी।
...
??? info "इस खंड से कैसे शुरू करें"
    ...
    कोर्स के इस सेक्शन में यह मान लिया गया है कि तुमने [भाग 2: सिंगल-सैंपल प्रोसेसिंग](./02_single_sample.md) पूरा कर लिया है और तुम्हारे पास एक काम करने वाली `{DOMAIN_DIR}.nf` पाइपलाइन है।

    अगर तुमने भाग 2 पूरा नहीं किया है या इस भाग के लिए नए सिरे से शुरू करना चाहते हो, तो तुम भाग 2 के समाधान को अपने शुरुआती बिंदु के रूप में उपयोग कर सकते हो।
    `nf4-science/{DOMAIN_DIR}/` डायरेक्टरी के अंदर से ये कमांड्स चलाओ:
    ...
    इससे तुम्हें एक पूर्ण सिंगल-सैंपल प्रोसेसिंग वर्कफ़्लो मिल जाएगी।
    तुम निम्नलिखित कमांड चलाकर टेस्ट कर सकते हो कि यह सफलतापूर्वक चलती है:
...
2. **{AGGREGATION_STEP_SUMMARY}.**
   इसमें `collect()` ऑपरेटर {AND_OTHER_CONCEPTS} का परिचय दिया गया है।
...
तुम जानते हो कि वर्कफ़्लो के व्यवहार को अनुकूलित करने के लिए प्रोसेस कमांड्स और आउटपुट्स को कैसे संशोधित करें।
...
### 2.2. Per-sample आउटपुट्स को collect करो और उन्हें एग्रीगेशन प्रोसेस में फीड करो
...
तुम्हारे पास एक पूर्ण पाइपलाइन है जो सैंपल्स को व्यक्तिगत रूप से प्रोसेस करती है और सभी सैंपल्स के परिणामों को एग्रीगेट करती है।
तुम जानते हो कि मल्टी-सैंपल विश्लेषण के लिए per-sample आउटपुट्स को एग्रीगेट करने के लिए `collect()` जैसे चैनल ऑपरेटर्स का उपयोग कैसे करें।

### आगे क्या है?

इस कोर्स को पूरा करने पर बधाई! तुमने क्या सीखा इसकी समीक्षा करने और अगले चरणों का पता लगाने के लिए [कोर्स सारांश](next_steps.md) पर जाओ।
