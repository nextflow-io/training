...
इससे पहले कि हम कोई भी वर्कफ़्लो कोड लिखना शुरू करें, हम कुछ टेस्ट डेटा पर कमांड को मैनुअली आज़माएंगे।
...
ये टूल GitHub Codespaces वातावरण में इंस्टॉल नहीं हैं, इसलिए हम इन्हें कंटेनर के माध्यम से उपयोग करेंगे (देखें [Hello Containers](../../hello_nextflow/05_hello_containers.md))।
...
#### 1.1.2. कंटेनर को इंटरैक्टिवली spin up करें

कंटेनर को spin up करो और `data` डायरेक्टरी को mount करो ताकि टूल इनपुट फ़ाइलों तक पहुँच सकें:
...
#### 1.2.2. कंटेनर को इंटरैक्टिवली spin up करें
...
सीखो कि उन्हीं कमांड को वर्कफ़्लो में कैसे wrap करना है जो कार्य को execute करने के लिए कंटेनर का उपयोग करते हैं।
