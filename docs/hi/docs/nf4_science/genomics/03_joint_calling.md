...
पहले, तुमने प्रति-नमूना वेरिएंट कॉलिंग पाइपलाइन बनाई जो प्रत्येक नमूने के डेटा को स्वतंत्र रूप से प्रोसेस करती थी।
अब हम इसे विस्तारित करके संयुक्त वेरिएंट कॉलिंग लागू करने जा रहे हैं, जैसा कि [भाग 1](01_method.md) में बताया गया है (मल्टी-सैंपल उपयोग केस)।

??? info "इस खंड से कैसे शुरू करें"

    कोर्स का यह सेक्शन मानता है कि तुमने [भाग 1: विधि अवलोकन](./01_method.md), [भाग 2: प्रति-नमूना वेरिएंट कॉलिंग](./02_per_sample_variant_calling.md) पूरा कर लिया है और तुम्हारे पास एक कार्यशील `genomics.nf` पाइपलाइन है।
...
यह [भाग 1: विधि अवलोकन](./01_method.md) में वर्णित विधि को लागू करता है (मल्टी-सैंपल उपयोग केस को कवर करने वाला दूसरा सेक्शन) और सीधे [भाग 2: प्रति-नमूना वेरिएंट कॉलिंग](./02_per_sample_variant_calling.md) द्वारा उत्पादित वर्कफ़्लो पर आधारित है।
...
यह [भाग 1: विधि अवलोकन](./01_method.md#2-joint-calling-on-a-cohort) के दूसरे सेक्शन से चरणों को स्वचालित करता है, जहां तुमने इन कमांड को उनके कंटेनर में मैन्युअली चलाया था।
...
ट्रेनिंग सीरीज़ में बाद में तुम सीखोगे कि इस तरह की चीज़ों के लिए नमूना मेटाडेटा का उपयोग कैसे करें, लेकिन अभी के लिए हम सिर्फ `params` का उपयोग करके एक CLI पैरामीटर घोषित करते हैं।
