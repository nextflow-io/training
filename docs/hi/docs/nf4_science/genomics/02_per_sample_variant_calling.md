...
अब, workflow ब्लॉक में `SAMTOOLS_INDEX` के लिए एक कॉल जोड़ो, इनपुट चैनल को आर्गुमेंट के रूप में पास करते हुए।
...
`bam_index` के लिए एक टार्गेट जोड़ो जो `bam/` सबडायरेक्टरी में पब्लिश करे।
