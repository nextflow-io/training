...
- Trimming (Trim Galore), alignment (HISAT2), quality control (FastQC) और report aggregation (MultiQC) के लिए processes जो अलग-अलग module फ़ाइलों में संग्रहीत हैं।
...
- बुनियादी RNAseq प्रोसेसिंग और QC methods लागू करने के लिए एक linear workflow लिखें
...
अब तुम अपने खुद के काम में RNAseq analysis workflows में Nextflow लागू करना शुरू करने के लिए तैयार हो।
...
- [Build with nf-core](../../hello_nf-core/index.md) के साथ nf-core की शुरुआत करें
...
मदद संसाधनों और community support के लिए, [Help पेज](../../help.md) देखें।
