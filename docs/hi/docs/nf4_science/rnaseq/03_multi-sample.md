...
पहले, तुमने एक प्रति-नमूना वेरिएंट कॉलिंग पाइपलाइन बनाई थी जो हर नमूने के डेटा को स्वतंत्र रूप से प्रोसेस करती थी।
...
??? info "इस खंड से कैसे शुरू करें"
    ...
    पाठ्यक्रम का यह सेक्शन मानता है कि तुमने [भाग 1: विधि अवलोकन](./01_method.md), [भाग 2: एकल-नमूना कार्यान्वयन](./02_single-sample.md) पूरा कर लिया है और तुम्हारे पास भरी हुई मॉड्यूल फ़ाइलों के साथ एक कार्यशील `rnaseq.nf` पाइपलाइन है।
...
यह [भाग 1: विधि अवलोकन](./01_method.md#2-multi-sample-qc-aggregation) के दूसरे सेक्शन से चरणों को स्वचालित करता है, जहां तुमने इन कमांड को उनके कंटेनरों में मैन्युअल रूप से चलाया था।
...
1. **workflow को कई इनपुट नमूने स्वीकार करने योग्य बनाएं।**
   यह एकल फ़ाइल पथ से CSV samplesheet पर स्विच करना, इसे `splitCsv()` से पार्स करना, और सभी मौजूदा processes को कई नमूनों पर चलाना कवर करता है।
...
3. **युग्मित-अंत RNAseq डेटा पर स्विच करें।**
   यह युग्मित-अंत इनपुट (tuples का उपयोग करके) के लिए processes को अनुकूलित करना, युग्मित-अंत मॉड्यूल बनाना, और एक अलग test profile सेट करना कवर करता है।

यह [भाग 1: विधि अवलोकन](./01_method.md) में वर्णित विधि को लागू करता है (बहु-नमूना उपयोग मामले को कवर करने वाला दूसरा सेक्शन) और भाग 2 द्वारा उत्पादित workflow पर सीधे निर्माण करता है।
...
कंटेनर URI था `community.wave.seqera.io/library/pip_multiqc:a3c26f6199d64b7c`।
...
यह process QC फ़ाइलों के लिए इनपुट क्वालिफायर के रूप में `#!groovy path '*'` का उपयोग करती है।
...
केवल आवश्यक परिवर्तन आउटपुट ब्लॉक में है: चूंकि हमें अब प्रति नमूना दो FastQC रिपोर्ट मिलती हैं, हम `simpleName`-आधारित पैटर्न से वाइल्डकार्ड पर स्विच करते हैं।
...
अंतिम [पाठ्यक्रम सारांश](./next_steps.md) पर जाओ यह समीक्षा करने के लिए कि तुमने क्या सीखा और आगे क्या आता है।
