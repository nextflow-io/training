...
यह बढ़िया है, लेकिन तुम सोच रहे होगे: आउटपुट कहाँ है?
...
तुम निम्नलिखित कमांड टाइप करके (अपने terminal में दिखाई देने वाले `a3/7be2fa` के साथ बदलते हुए) और path को autocomplete करने के लिए tab key दबाकर या asterisk जोड़कर पूरा path पा सकते हो:
...
सीखो कि बुनियादी Nextflow स्क्रिप्ट कैसे पढ़ें और पहचानो कि इसके घटक इसकी functionality से कैसे संबंधित हैं।
...
अब जब हमने देख लिया है कि यह क्या करती है, तो चलो box खोलते हैं और अंदर देखते हैं।
...
चलो editor pane में `hello-world.nf` स्क्रिप्ट खोलते हैं।
...
Process body में एक script block होना चाहिए जो चलाने के लिए कमांड निर्दिष्ट करता है, जो कुछ भी हो सकता है जिसे तुम command line terminal में चला सकते हो।
...
अब तुम जानते हो कि एक साधारण Nextflow workflow कैसे structured है, और बुनियादी घटक इसकी functionality से कैसे संबंधित हैं।

### आगे क्या है?

अपने workflow executions को सुविधाजनक रूप से प्रबंधित करना सीखो।
...
Process status line (line 5) में जोड़े गए `cached:` bit को देखो, जिसका अर्थ है कि Nextflow ने पहचान लिया है कि उसने यह काम पहले ही कर लिया है और बस पिछले सफल run के परिणाम का पुन: उपयोग किया।
