...
यदि तुम्हें अगले महीने फिर से वही विश्लेषण चलाने की आवश्यकता हो तो क्या होगा?
यदि कोई सहयोगी तुम्हारी सटीक सेटिंग्स का उपयोग करना चाहता है तो क्या होगा?
...
बस इतना ही! पैरामीटर फ़ाइल तुम्हारे सटीक कॉन्फ़िगरेशन को दस्तावेज़ित करती है और इसे फिर से चलाना या साझा करना आसान बनाती है।
...
इसके अतिरिक्त, तुम देख सकते हो कि `-resume` फ़्लैग ने हमें पिछले रन से प्री-प्रोसेसिंग परिणामों का पुन: उपयोग करने की अनुमति दी, जिससे समय की बचत हुई।
तुम इस पैटर्न का उपयोग pipeline के विभिन्न विविधताओं का शीघ्रता से परीक्षण करने के लिए कर सकते हो।

### सारांश

पैरामीटर फ़ाइलें तुम्हारे विश्लेषण को पुनरुत्पादनीय और साझा करने में आसान बनाती हैं।
किसी भी वास्तविक विश्लेषण कार्य के लिए इनका उपयोग करो।

### आगे क्या है?

जानो कि samplesheets कैसे कई नमूनों के बारे में जानकारी को व्यवस्थित करती हैं।
...
Samplesheet एक CSV फ़ाइल है जो तुम्हारे इनपुट नमूनों का वर्णन करती है।
प्रत्येक पंक्ति एक नमूना है, और कॉलम उस नमूने के लिए फ़ाइलों और मेटाडेटा को निर्दिष्ट करते हैं।

आओ देखें कि हम किस samplesheet का उपयोग कर रहे हैं:
...
तुम एक ही samplesheet में पथ प्रकारों को मिक्स कर सकते हो।

### 2.3. अपनी खुद की samplesheet बनाना

सबसे पहले, आओ परीक्षण डेटा फ़ाइलों को स्थानीय रूप से डाउनलोड करें:
...
अब आओ इन स्थानीय फ़ाइलों का संदर्भ देने के लिए samplesheet को संशोधित करें:
...
!!! Warning "चेतावनी"
    ...
    ध्यान दो कि samplesheet में पथ वहाँ से सापेक्ष हैं जहाँ तुम Nextflow **चलाते** हो, न कि जहाँ samplesheet स्थित है।

अंत में, आओ स्थानीय फ़ाइल पथों के साथ samplesheet के साथ nf-core/molkart को एक बार फिर से निष्पादित करें:

`nextflow run ./molkart -params-file params.yaml -resume`

जैसा कि तुम देख सकते हो, Nextflow इस रन को उसी तरह निष्पादित करता है जैसे कि फ़ाइलें Github से डाउनलोड की गई थीं। यह Nextflow की महान विशेषताओं में से एक है, यह तुम्हारे लिए डेटा को ठीक से व्यवस्थित करता है, चाहे वह कहीं भी स्थित हो।

### सारांश

Samplesheets बहु-नमूना डेटासेट को इस तरह व्यवस्थित करती हैं जो तुम्हें फ़ाइल पथों के साथ अपने मेटाडेटा को स्पष्ट रूप से परिभाषित करने की अनुमति देती हैं।
अधिकांश nf-core pipelines इस पैटर्न का उपयोग करती हैं।

### आगे क्या है?

अब जब हमने इनपुट को कवर कर लिया है, तो आओ जानें कि विभिन्न कंप्यूटिंग वातावरण के लिए Nextflow pipelines को कैसे कॉन्फ़िगर किया जाए।
