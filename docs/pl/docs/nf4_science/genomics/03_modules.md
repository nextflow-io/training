...
Jak nauczyłeś się w [Hello Modules](../../../hello_nextflow/hello_modules.md), możesz utworzyć moduł, po prostu kopiując definicję procesu do osobnego pliku, w dowolnym katalogu, i możesz nazwać ten plik, jak chcesz.
...
Przejrzyj to, czego się nauczyłeś, i spójrz na to, co czeka dalej: testowanie.
