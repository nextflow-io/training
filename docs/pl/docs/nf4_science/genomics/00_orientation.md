...
W trakcie kursu używamy wyjścia polecenia `tree` do przedstawienia struktury katalogów i ich zawartości w czytelnej formie, czasami z niewielkimi modyfikacjami dla przejrzystości.
...
- **Plik `genomics.nf`** to skrypt workflow'a, który będziesz budować w trakcie kursu.
