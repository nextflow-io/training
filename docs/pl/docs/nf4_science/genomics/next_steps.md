...
Jest to platforma chmurowa opracowana przez twórców Nextflow, którą można połączyć z własną infrastrukturą obliczeniową (lokalną, HPC lub chmurową), aby znacznie ułatwić uruchamianie i zarządzanie workflow, a także zarządzanie danymi i przeprowadzanie analiz interaktywnie w środowisku chmurowym.
