...
Przechodząc przez ten kurs, nauczysz się, jak stosować podstawowe koncepcje i narzędzia Nextflow w typowym przypadku użycia z dziedziny genomiki.

Pod koniec tego warsztatu będziesz w stanie:

- Napisać liniowy workflow wykrywający warianty dla pojedynczej próbki
