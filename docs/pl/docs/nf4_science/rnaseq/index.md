...
Opiera się na szkoleniu dla początkujących [Hello Nextflow](../../hello_nextflow/) i demonstruje, jak używać Nextflow'a w konkretnym kontekście analizy masowego RNAseq.
...
Zacznijmy! Kliknij przycisk "Open in GitHub Codespaces" poniżej, aby uruchomić środowisko szkoleniowe (najlepiej w osobnej karcie), a następnie kontynuuj czytanie podczas jego ładowania.
...
- Wykorzystać paradygmat przepływu danych Nextflow'a do paralelizacji przetwarzania RNAseq na poziomie próbek
