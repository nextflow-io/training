...
Potrzebujesz jednak (darmowego) konta, aby się zalogować. Warto także poświęcić kilka minut na zapoznanie się z interfejsem.
...
!!!note "Uwaga"
    ...
    Nie martw się, jeśli wydaje się to przytłaczające. Przejdziemy przez odpowiednie elementy na każdym etapie kursu.
