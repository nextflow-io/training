...
Jest to platforma w chmurze opracowana przez twórców Nextflow, którą możesz połączyć z własną infrastrukturą obliczeniową (lokalną, HPC lub chmurową), aby znacznie ułatwić uruchamianie i zarządzanie workflow, a także zarządzać danymi i przeprowadzać analizy interaktywnie w środowisku chmurowym.
