...
W tej części kursu napiszemy najprostszy możliwy workflow, który obejmie wszystkie polecenia uruchomione w Części 1, aby zautomatyzować ich wykonywanie. Będziemy przetwarzać jedną próbkę na raz.
...
Utworzymy samodzielne moduły dla każdego procesu, aby ułatwić zarządzanie i ponowne wykorzystanie, więc stwórzmy katalog do ich przechowywania.
...
Przycięte odczyty znajdują się w kanale `TRIM_GALORE.out.trimmed_reads`, który jest wyjściem z poprzedniego kroku.
