...
Zanim zaczniemy pisać jakikolwiek kod workflow'a, przetestujemy polecenia manualnie na danych testowych.
...
Te narzędzia nie są zainstalowane w środowisku GitHub Codespaces, więc użyjemy ich poprzez kontenery (zobacz [Hello Containers](../../hello_nextflow/05_hello_containers.md)).
