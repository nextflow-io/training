...
- :material-book-open-variant:{ .lg .middle } **Kursy do samodzielnej nauki**
...
- :material-information-outline:{ .lg .middle } **Dodatkowe informacje**
...
- :material-walk:{ .lg .middle } **Ścieżka wprowadzająca**
...
- :material-run:{ .lg .middle } **Ścieżka zaawansowana**
