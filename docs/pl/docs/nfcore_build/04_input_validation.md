# Część 4: Walidacja danych wejściowych
...
??? info "Jak zacząć od tej sekcji"
    ...
    Ta sekcja zakłada, że ukończyłeś [Część 3: Tworzenie modułu nf-core](./03_make_module.md) i zaktualizowałeś moduł procesu `COWPY` do standardów nf-core w Swoim pipeline'ie.
