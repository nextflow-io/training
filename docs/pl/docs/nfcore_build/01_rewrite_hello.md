# Część 1: Przepisanie Hello dla nf-core

<span class="ai-translation-notice">:material-information-outline:{ .ai-translation-notice-icon } Tłumaczenie wspomagane przez AI - [dowiedz się więcej i zasugeruj ulepszenia](https://github.com/nextflow-io/training/blob/master/TRANSLATING.md)</span>

W tej pierwszej części kursu szkoleniowego Build with nf-core pokażemy Ci, jak utworzyć wersję pipeline'u kompatybilną z nf-core, opartą na projekcie z kursu dla początkujących [Hello Nextflow](../hello_nextflow/index.md).
...
Przyjrzyjmy się więc, jak kod pipeline'u jest zorganizowany w repozytorium `nf-core/demo`, używając dowiązania symbolicznego `pipelines` utworzonego podczas [Pierwszych kroków](00_orientation.md).
...
Po zakończeniu działania TUI narzędzie informuje, że utworzyło pipeline, wygenerowało jego konfigurację kontenerów i zainicjalizowało lokalne repozytorium git dla nowego pipeline'u:
...
??? note "Blok `channel.topic`"
    ...
    Część 3 tego kursu szczegółowo wyjaśnia, jak działa.
...
Wyjaśnimy go w Części 3; na razie traktuj go jako standardowy kod, który możesz pozostawić bez zmian.
...
Zrób sobie przerwę, to była ciężka praca! Kiedy będziesz gotowy, przejdź do [Części 2: Użycie modułu nf-core](./02_use_module.md), aby nauczyć się, jak wykorzystać moduły utrzymywane przez społeczność z repozytorium nf-core/modules.
