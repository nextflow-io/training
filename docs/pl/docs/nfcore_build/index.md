...
additional_information:
  ...
  audience_prerequisites:
    ...
    - "**Kursy:** Wymagane jest ukończenie kursów [Hello Nextflow](../hello_nextflow/index.md) i [Use nf-core](../nfcore_use/index.md) lub posiadanie równoważnego doświadczenia."
...
Podzieliliśmy to na cztery części, z których każda skupi się na określonych aspektach korzystania z zasobów nf-core.

| Rozdział kursu                                                  | Podsumowanie                                                                                                                                                            | Szacowany czas |
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [Część 1: Przepisanie Hello dla nf-core](./01_rewrite_hello.md) | Dostosowanie istniejącego workflow'u do szkieletu szablonu nf-core, zaczynając od prostego workflow'u utworzonego w kursie [Hello Nextflow](../hello_nextflow/index.md) | 60 min         |
| [Część 2: Użycie modułu nf-core](./02_use_module.md)            | Eksploracja biblioteki modułów społeczności i nauka integrowania gotowych, przetestowanych modułów opakowujących popularne narzędzia bioinformatyczne                   | 30 min         |
| [Część 3: Stworzenie modułu nf-core](./03_make_module.md)       | Tworzenie własnego modułu w stylu nf-core przy użyciu określonej struktury, konwencji nazewnictwa i wymagań dotyczących metadanych ustanowionych przez nf-core          | 30 min         |
| [Część 4: Dodanie walidacji wejścia](./04_input_validation.md)  | Implementacja walidacji wejścia zarówno dla parametrów wiersza poleceń, jak i plików danych wejściowych przy użyciu nf-schema                                           | 30 min         |
