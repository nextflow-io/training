...
Ten przewodnik zakłada, że ukończyłeś kurs [Hello Nextflow](../../hello_nextflow/index.md) i swobodnie poruszasz się po podstawowych koncepcjach Nextflow, w tym:
...
Spróbuj wyszukać `container` w całej przestrzeni roboczej:

![Wyszukiwanie w projekcie](../img/project_search.png)

Pokazuje to każdy plik, który używa dyrektywy container, pomagając Ci:

- Zrozumieć, które procesy używają kontenerów
