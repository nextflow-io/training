...
1. Otwórz VS Code
2. Przejdź do widoku rozszerzeń, klikając ikonę rozszerzeń po lewej stronie: ![ikona rozszerzeń](../../../en/docs/side_quests/img/extensions_icon.png) (skrót `Ctrl/Cmd+Shift+X`, jeśli uruchamiasz VSCode lokalnie)
3. Wyszukaj "Nextflow"
4. Zainstaluj oficjalne rozszerzenie Nextflow

![Instalacja rozszerzenia Nextflow](../../../en/docs/side_quests/img/install_extension.png)
...
- **Eksplorator plików** kliknij (![ikona eksploratora plików](../../../en/docs/side_quests/img/files_icon.png)) (`Ctrl/Cmd+Shift+E`): Lokalne pliki i foldery w Twoim systemie. Trzymaj to otwarte po lewej stronie, aby nawigować między plikami
...
![Prezentacja składni](../../../en/docs/side_quests/img/syntax_showcase.png)
...
![Automatyczne uzupełnianie kanału](../../../en/docs/side_quests/img/autocomplete_channel.png)
...
![Automatyczne uzupełnianie operacji na kanałach](../../../en/docs/side_quests/img/autocomplete_operators.png)

#### Dyrektywy procesu

Wewnątrz bloku script procesu wpisz `task.`, aby zobaczyć dostępne właściwości wykonania:

![Automatyczne uzupełnianie właściwości task](../../../en/docs/side_quests/img/autocomplete_task.png)

#### Konfiguracja

Otwórz nextflow.config i wpisz `process.` w dowolnym miejscu, aby zobaczyć dostępne dyrektywy procesu:

![Automatyczne uzupełnianie konfiguracji](../../../en/docs/side_quests/img/autocomplete_config.png)
...
![Podkreślenie błędu](../../../en/docs/side_quests/img/error_underline.png)
...
![Filtrowanie panelu problemów](../../../en/docs/side_quests/img/active_file.png)

Kliknij dowolny problem, aby przejść bezpośrednio do problematycznej linii

![Panel problemów](../../../en/docs/side_quests/img/problems_panel.png)
...
![Przejdź do definicji](../../../en/docs/side_quests/img/syntax.png)
...
![Podążaj za linkiem](../../../en/docs/side_quests/img/follow_link.png)
...
![Nawigacja po symbolach](../../../en/docs/side_quests/img/symbols.png)
...
![Znajdź odniesienia](../../../en/docs/side_quests/img/references.png)
...
![Podgląd DAG](../../../en/docs/side_quests/img/dag_preview.png)
...
![Podgląd DAG wewnętrznego workflow](../../../en/docs/side_quests/img/dag_preview_inner.png)
...
![Podzielony edytor](../../../en/docs/side_quests/img/split_editor.png)
...
![Wyszukiwanie w projekcie](../../../en/docs/side_quests/img/project_search.png)
...
![Składanie kodu](../../../en/docs/side_quests/img/code_folding.png)
...
Otwórz panel Source Control, używając przycisku kontroli źródła (![Ikona kontroli źródła](../../../en/docs/side_quests/img/source_control_icon.png)) (`Ctrl+Shift+G` lub `Cmd+Shift+G`, jeśli pracujesz z VSCode lokalnie), aby zobaczyć zmiany git i dokonywać commit bezpośrednio w edytorze.

![Panel Source Control](../../../en/docs/side_quests/img/source_control.png)
