...
Dla obrazu kontenera `quote` możesz użyć tego, który sam zbudowałeś w poprzednim dodatkowym ćwiczeniu, lub użyć tego, który otrzymałeś z Seqera Containers.
...
Wiesz już, jak używać kontenerów w Nextflow'ie do uruchamiania procesów oraz jak wbudować logikę rozgałęzień do swoich pipeline'ów!
