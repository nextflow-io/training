...
Pracując z praktycznymi przykładami i prowadzonymi ćwiczeniami, poznasz podstawy tworzenia pipeline'ów w Nextflow, w tym jak definiować procesy, łączyć je w pipeline'y, zarządzać plikami i zależnościami oprogramowania, równolegle wykonywać zadania bez dodatkowego wysiłku oraz uruchamiać workflow'y w różnych środowiskach obliczeniowych.
...
| [Część 2: Hello Channels](./02_hello_channels.md)     | Używanie kanałów i operatorów do przetwarzania wejść i równoległego wykonywania bez dodatkowego wysiłku                 | 45 min         |
...
| [Część 4: Hello Modules](./04_hello_modules.md)       | Stosowanie zasad modularności kodu w celu zwiększenia możliwości ponownego użycia i zmniejszenia obciążenia konserwacji | 20 min         |
...
Pod koniec tego kursu będziesz dobrze przygotowany do podjęcia kolejnych kroków w Swojej drodze do tworzenia powtarzalnych workflow'ów dla Twoich potrzeb w dziedzinie obliczeń naukowych.
