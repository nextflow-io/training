...
- **Os arquivos `.nf`** são scripts de fluxo de trabalho que são numerados com base em qual parte do curso eles são usados.
...
**Para continuar para [Parte 1: Executar operações básicas](./01_basics.md), clique na seta no canto inferior direito desta página.**
