...
- Comece com nf-core com [Build with nf-core](../hello_nf-core/index.md)
- Aprenda técnicas de solução de problemas com a [Side Quest de Debugging](../side_quests/debugging/index.md)
