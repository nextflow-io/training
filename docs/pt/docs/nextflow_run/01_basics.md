...
??? question "Se não funcionou"
    ...
    Então você provavelmente está usando o parser de linguagem Nextflow v1 mais antigo.
    ...
    Resumindo, se você está usando Nextflow `25.10`, então precisa habilitar o parser de linguagem v2:
