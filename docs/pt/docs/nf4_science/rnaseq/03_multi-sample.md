...
- A saída muda para refletir as convenções de nomenclatura paired-end do Trim Galore, produzindo relatórios FastQC separados para cada arquivo de leitura
