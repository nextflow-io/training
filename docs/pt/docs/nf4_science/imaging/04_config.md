...
- Explore [Build with nf-core](../../nfcore_build/index.md) para mergulhar mais fundo nas ferramentas nf-core
- Explore tópicos mais avançados nos [Side Quests](../../side_quests/index.md)
