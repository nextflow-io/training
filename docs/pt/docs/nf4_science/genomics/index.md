...
additional_information:
  ...
  audience_prerequisites:
    ...
    - "**Pré-requisitos:** Conceitos e ferramentas fundamentais do Nextflow abordados em [Hello Nextflow](../../hello_nextflow/)."
---
...
Você implementará um pipeline de chamada de variantes com [GATK](https://gatk.broadinstitute.org/) (Genome Analysis Toolkit), um pacote de software amplamente utilizado para análise de dados de sequenciamento de alto rendimento.
