...
Como ponto de partida, fornecemos um arquivo de fluxo de trabalho, `{DOMAIN_DIR}.nf`, que descreve as principais partes do fluxo de trabalho, bem como dois arquivos de módulo, {TOOL_A_MODULE}.nf e {TOOL_B_MODULE}.nf, que descrevem a estrutura dos módulos.
