# Parte 2: Usar um módulo nf-core

<span class="ai-translation-notice">:material-information-outline:{ .ai-translation-notice-icon } Tradução assistida por IA - [saiba mais e sugira melhorias](https://github.com/nextflow-io/training/blob/master/TRANSLATING.md)</span>

Nesta segunda parte do curso de treinamento Build with nf-core, mostramos como encontrar, instalar e usar um módulo nf-core existente no seu pipeline.
...
??? info "Como começar a partir desta seção"
    ...
    Esta seção do curso assume que você completou a [Parte 1: Reescrever Hello para nf-core](./01_rewrite_hello.md) e tem um pipeline `core-hello` funcionando.

    Se você não completou a Parte 1 ou quer começar do zero para esta parte, você pode usar a solução `core-hello-part1` como ponto de partida.
    Execute este comando dentro do diretório `nfcore-build/`:
...
Abra `core-hello/workflows/hello.nf` e faça a seguinte substituição:
