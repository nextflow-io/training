...
additional_information:
  ...
  audience_prerequisites:
    ...
    - "**Cursos:** Deve ter completado [Hello Nextflow](../hello_nextflow/index.md) e [Use nf-core](../nfcore_use/index.md), ou ter experiência equivalente."
...
Dividimos isso em quatro partes, cada uma focando em aspectos específicos do uso de recursos nf-core.

| Capítulo do curso                                                  | Resumo                                                                                                                                                                         | Duração estimada |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| [Parte 1: Reescreva Hello para nf-core](./01_rewrite_hello.md)     | Adapte um fluxo de trabalho existente ao modelo de estrutura nf-core, começando pelo fluxo de trabalho simples produzido no curso [Hello Nextflow](../hello_nextflow/index.md) | 60 minutos       |
| [Parte 2: Use um módulo nf-core](./02_use_module.md)               | Explore a biblioteca de módulos da comunidade e aprenda a integrar módulos pré-construídos e testados que encapsulam ferramentas de bioinformática comuns                      | 30 minutos       |
| [Parte 3: Crie um módulo nf-core](./03_make_module.md)             | Crie seu próprio módulo no estilo nf-core usando a estrutura específica, convenções de nomenclatura e requisitos de metadados estabelecidos pelo nf-core                       | 30 minutos       |
| [Parte 4: Adicione validação de entrada](./04_input_validation.md) | Implemente validação de entrada tanto para parâmetros de linha de comando quanto para arquivos de dados de entrada usando nf-schema                                            | 30 minutos       |
