...
Fazer esses exercícios _não é obrigatório_ para entender as partes posteriores do treinamento, mas fornecem uma maneira divertida de reforçar seu aprendizado ao descobrir como fazer a vaca citar cientistas famosos.
