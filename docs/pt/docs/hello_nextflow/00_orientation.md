...
!!! tip "Dica"
    ...
    Os vídeos do YouTube têm super poderes!

    - :fontawesome-solid-closed-captioning: Legendas de alta qualidade (curadas manualmente). Ative-as com o ícone :material-subtitles:
