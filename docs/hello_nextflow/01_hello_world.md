...
### 3.1. Add a `publishDir` directive to the `sayHello` process
...
Here we show you how to use the `resume` feature for when you need to re-launch the same workflow, and how to delete older work directories.
