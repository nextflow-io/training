...
Comencem! Feu clic al botó "Open in GitHub Codespaces" a continuació per iniciar l'entorn de formació (preferiblement en una pestanya separada), i després continueu llegint mentre es carrega.
...
- Executar un workflow de Nextflow localment i monitoritzar l'execució
- Trobar i interpretar sortides (resultats) i fitxers de registre generats per Nextflow
- Executar un pipeline d'nf-core amb dades de prova i entrades personalitzades
