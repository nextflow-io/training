...
Abans d'endinsar-nos en l'escriptura de qualsevol codi de workflow, provarem les comandes manualment amb algunes dades de prova.
...
En aquesta secció provem les comandes que conformen l'enfocament de processament de mostra única.
...
El vostre indicador hauria de tornar a la normalitat.
Això conclou la prova de processament de mostra única.
