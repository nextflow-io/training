...
Aquest curs es basa en la formació per a principiants [Hello Nextflow](../../hello_nextflow/index.md) i demostra com utilitzar Nextflow en el context específic de l'anàlisi d'RNAseq bulk.
