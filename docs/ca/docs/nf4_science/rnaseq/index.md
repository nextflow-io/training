...
| [Part 3: Implementació multi-mostra paired-end](./03_multi-sample.md) | Estendre el pipeline per gestionar dades paired-end i agregar informes de QC a través de mostres                                    | 45 min          |
