...
En aquesta part del curs, escriurem el workflow més senzill possible que encapsuli totes les comandes que vam executar a la Part 1 per automatitzar-ne l'execució, i processarem només una mostra cada vegada.
...
#### 2.2.1. Afegir objectius de publicació per a les sortides de retallat
...
=== "Després"
    ...
    params {
        ...
        // Arxiu de referència del genoma
...
Les lectures retallades estan al canal de sortida `TRIM_GALORE.out.trimmed_reads` produït pel pas anterior.
...
#### 3.3.1. Afegir objectius de publicació per a les sortides d'alineament
