...
- **L'editor principal** és on s'obriran el codi de Nextflow i altres fitxers de text. Aquí és on editareu el codi. Quan obriu el codespace, això us mostrarà una previsualització del fitxer `README.md`.
