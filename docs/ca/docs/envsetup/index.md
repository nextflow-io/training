...
Amb aquesta finalitat, hem desenvolupat un entorn contenidoritzat que conté tot el programari necessari, els fitxers de codi i les dades d'exemple per treballar tots els nostres cursos.
...
Si cap de les opcions anteriors s'adapta a les vostres necessitats, podeu replicar aquest entorn al vostre propi sistema local instal·lant les dependències de programari manualment i clonant el repositori de formació.
