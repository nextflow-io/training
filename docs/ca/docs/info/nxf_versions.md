...
Depenent de la generació de codi Nextflow que tingueu previst migrar, és possible que pugueu fer la major part utilitzant el linter de Nextflow amb la comanda `nextflow lint -format`.
