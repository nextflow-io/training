...
- Valida que existeixen les rutes de fitxers
...
- Valida que existeixen les rutes de fitxers referenciades al full de mostra
...
- **`exists`**: Per a rutes de fitxers, comprova si el fitxer existeix
