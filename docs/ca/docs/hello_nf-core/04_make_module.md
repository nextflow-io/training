...
!!! note "Compatibilitat amb versions anteriors"
...
Per a l'entorn Conda, el codi del mòdul especifica `conda "${moduleDir}/environment.yml"` el que significa que hauria d'estar configurat al fitxer `environment.yml`.
