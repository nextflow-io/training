...
### 1.2. Modifica el teu pipeline de Nextflow perquè pugui executar-se en els modes `quote` i `sayHello`.
...
Ja saps com utilitzar contenidors a Nextflow per executar processos, i com construir una mica de lògica de ramificació als teus pipelines!
