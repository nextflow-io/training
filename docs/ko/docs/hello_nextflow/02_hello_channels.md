...
또한 필요에 따라 channel 내용을 변환하기 위해 [**연산자**](https://www.nextflow.io/docs/latest/reference/operator.html)를 사용하는 방법도 배웁니다.
...
파일 경로 처리를 위한 일부 내장 기능이 있는 새로운 channel 팩토리 [`channel.fromPath()`](https://www.nextflow.io/docs/latest/reference/channel.html#frompath)를 사용하도록 전환해야 합니다.
...
??? failure "명령 출력"
    ...
    Before splitCsv: /workspaces/training/hello-nextflow/data/gr
