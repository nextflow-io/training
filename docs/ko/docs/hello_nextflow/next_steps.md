...
여섯 부분에 걸쳐 그 기본 워크플로우를 채널, 연산자, 컨테이너에 대한 내장 지원, 구성 옵션을 포함한 Nextflow의 핵심 기능을 활용하는 모듈식 다단계 파이프라인으로 변환했습니다.
...
- [과학을 위한 Nextflow](../nf4_science/index.md)로 과학적 분석 사용 사례에 Nextflow 적용하기
