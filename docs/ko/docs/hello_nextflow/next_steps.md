...
여섯 부분에 걸쳐 그 기본 워크플로우를 채널, 연산자, 컨테이너에 대한 내장 지원 및 설정 옵션을 포함한 Nextflow의 핵심 기능을 활용하는 모듈식 다단계 파이프라인으로 변환했습니다.
...
워크플로우 설정은 유연하고 재현 가능한 방식으로 입력과 매개변수를 제공할 수 있도록 지원합니다.
