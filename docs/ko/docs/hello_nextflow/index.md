...
| 과정 챕터                                            | 요약                                                                    | 예상 소요 시간 |
| ---------------------------------------------------- | ----------------------------------------------------------------------- | -------------- |
| [파트 1: Hello World](./01_hello_world.md)           | Nextflow 워크플로우를 구성하고 실행하는 데 관련된 기본 구성 요소 및 원리 | 30분           |
...
| [파트 6: Hello Config](./06_hello_config.md)         | 파이프라인 동작의 맞춤화 및 다양한 컴퓨팅 환경에서의 사용 최적화         | 60분           |
