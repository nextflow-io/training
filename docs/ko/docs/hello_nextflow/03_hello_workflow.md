...
이 교육 모듈에서는 다단계 워크플로우에서 프로세스를 함께 연결하는 방법을 배웁니다.
...
일괄 프로세스 호출에서 출력을 수집하고 단일 프로세스에 공급하는 방법을 배웁니다.
...
자세히 알아보기: [3. 프로세스에 둘 이상의 입력 전달](#3-프로세스에-추가-매개변수-전달)
</quiz>
