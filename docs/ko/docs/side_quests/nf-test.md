...
더 고급 테스트 기능과 모범 사례는 [nf-test 문서](https://www.nf-test.com/)를 확인하세요. 다음을 원할 수 있습니다:
...
**기억하세요:** 테스트는 코드가 어떻게 동작해야 하는지에 대한 살아있는 문서입니다. 더 많은 테스트를 작성하고 단언문을 더 구체적으로 만들수록 파이프라인의 신뢰성에 대해 더 확신할 수 있습니다.
