...
- Bash 또는 동등한 셸
- [Java 21 이상](https://www.oracle.com/technetwork/java/javase/downloads/index.html) (Nextflow 실행에는 Java 17 이상으로 충분하지만, [플러그인 개발](../side_quests/plugin_development/index.md) 과정에는 Java 21이 필요합니다)
