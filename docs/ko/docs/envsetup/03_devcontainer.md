...
![VS Code에서 Dev Containers 확장 프로그램 설치](../../../en/docs/envsetup/img/install_extension.png)
...
![컨테이너에서 다시 열기 프롬프트](../../../en/docs/envsetup/img/reopen_prompt.png)

![로컬 구성 선택](../../../en/docs/envsetup/img/select_local_config.png)
...
![devcontainer가 실행 중인 VS Code](../../../en/docs/envsetup/img/running_container.png)
