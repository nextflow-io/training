...
![검색 결과](../../../en/docs/hello_nf-core/img/search-results.png)
...
![파이프라인 지하철 노선도](../../../en/docs/hello_nf-core/img/nf-core-demo-subway-cropped.png)
...
![실행 타임라인 보고서](../../../en/docs/hello_nf-core/img/execution_timeline.png)
