...
| 과정 챕터                                              | 요약                                                                              | 예상 소요 시간 |
| ------------------------------------------------------ | --------------------------------------------------------------------------------- | -------------- |
| [파트 1: 방법론 개요](./01_method.md)                  | RNAseq 처리 방법론 이해 및 도구를 수동으로 실행하기                               | 30분           |
| [파트 2: 단일 샘플 구현](./02_single-sample.md)        | 단일 샘플을 트리밍, 정렬 및 QC하는 파이프라인 구축 후 여러 샘플 처리로 확장하기   | 60분           |
| [파트 3: 다중 샘플 쌍 말단 구현](./03_multi-sample.md) | 쌍 말단 데이터를 처리하고 샘플 전체에 걸쳐 QC 리포트를 집계하도록 파이프라인 확장 | 45분           |
