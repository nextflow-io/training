...
그런 다음 프로세스를 자동화하기 위한 단일 샘플 Nextflow 파이프라인을 구축하고, 여러 샘플을 병렬로 처리하도록 확장했으며, 다중 샘플 {AGGREGATION_SUMMARY}를 추가했습니다.
...
- [Build with nf-core](../../nfcore_build/index.md)로 nf-core 시작하기
