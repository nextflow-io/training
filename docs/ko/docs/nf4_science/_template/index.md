...
**{METHOD_SHORT_DESCRIPTION}에 Nextflow를 적용하는 실습 과정입니다.**

이 과정은 [Hello Nextflow](../../hello_nextflow/) 초급 교육을 기반으로 하며, {DOMAIN} 분야의 특정 맥락에서 Nextflow를 사용하는 방법을 다룹니다.
...
이 과정은 {DOMAIN} 사용 사례에 Nextflow를 적용하는 특정 측면에 초점을 맞춘 세 부분으로 나뉩니다.

| 과정 챕터                                                 | 요약                                                                                  | 예상 소요 시간 |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------- | -------------- |
| [Part 1: Method overview](./01_method.md)                 | {METHOD} 방법론 이해 및 도구 수동 실행                                               | 30분           |
| [Part 2: Single-sample processing](./02_single_sample.md) | {PART2_SUMMARY}하는 파이프라인 구축 후 여러 샘플로 확장                               | 60분           |
