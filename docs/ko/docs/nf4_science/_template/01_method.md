...
이 도구들은 GitHub Codespaces 환경에 설치되어 있지 않으므로, 컨테이너를 통해 사용하겠습니다([Hello Containers](../../hello_nextflow/05_hello_containers.md) 참조).
...
{TOOL_A}와 {TOOL_B} 명령을 각각의 컨테이너에서 테스트하는 방법을 학습했습니다. 여기에는 {MULTI_SAMPLE_SUMMARY} 방법도 포함됩니다.
