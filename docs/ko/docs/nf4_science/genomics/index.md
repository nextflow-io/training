...
additional_information:
  ...
  learning_objectives:
    ...
    - 관련 채널 연산자를 사용하여 다중 샘플 결합 호출 구현하기
...
| [Part 2: 샘플별 변이 호출](./02_per_sample_variant_calling.md) | BAM 파일을 인덱싱하고 변이를 호출하는 파이프라인 구축, 그 다음 여러 샘플로 확장 | 60분           |
| [Part 3: 코호트에 대한 결합 호출](./03_joint_calling.md)       | 채널 연산자를 사용하여 샘플별 출력을 집계하는 다중 샘플 결합 유전자형 추가      | 45분           |
