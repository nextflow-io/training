...
먼저 워크플로우에 래핑하기 전에 명령을 수동으로 시도해보고 싶습니다.
...
동일한 명령을 컨테이너를 사용하여 작업을 실행하는 2단계 워크플로우로 래핑하는 방법을 배웁니다.
...
게놈학 도구를 단일 단계 Nextflow 워크플로우로 래핑하고 컨테이너를 사용하여 실행하는 방법을 알게 되었습니다.
