...
1. **[Workflows of Workflows](../../side_quests/workflows_of_workflows)** - 복잡한 workflow 아키텍처 및 구성
2. **[Testing with nf-test](../../side_quests/nf-test)** - Nextflow workflow를 위한 테스트 전략
3. **[Metadata](../../side_quests/metadata)** - Nextflow channel의 항목에 대한 메타데이터 처리
