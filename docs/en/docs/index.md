...
- :material-book-open-variant:{ .lg .middle } **Self-service courses**
...
- :material-information-outline:{ .lg .middle } **Additional information**
...
- :material-walk:{ .lg .middle } **Introductory track**
...
- :material-run:{ .lg .middle } **Advanced track**
