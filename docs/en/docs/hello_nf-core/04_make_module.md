...
!!! tip "Learn more about testing"
    ...
    The generated test file uses nf-test, a testing framework for Nextflow pipelines and modules. To learn how to write and run these tests, see the [nf-test side quest](../side_quests/nf-test.md).
