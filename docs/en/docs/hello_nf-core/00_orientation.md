...
If you've already completed the [nf-core Run](../nfcore_run/index.md) course, `nf-core/demo` is already cached locally, but the symlink above still needs to be created fresh in this directory.
