...
1. **[Workflows of Workflows](../side_quests/workflows_of_workflows/index.md)** - Complex workflow architecture and composition
2. **[Testing with nf-test](../side_quests/nf_test/index.md)** - Testing strategies for Nextflow workflows
3. **[Metadata](../side_quests/metadata/index.md)** - Handling metadata for items in Nextflow channels
4. **[Splitting and Grouping](../side_quests/splitting_and_grouping/index.md)** - Advanced data processing patterns
