...
!!! warning "This course has been retired"

    This is a previous version of the Nextflow Run course, kept here for reference only.
    It is no longer maintained or linked from the site navigation.
    For the current course, see [Nextflow Run](../../nextflow_run/index.md).
