...
=== "Additional information"
    ...
    ??? people "Information for trainers"
        ...
        In addition, we'd love to hear from you on how we could better support your training efforts! Please contact us at community@seqera.io or on the community forum (see [Help](help.md) page).

    ??? github "Credits and contributions"
...
!!! catalog "Intro track"
    ...
    ### :material-compass:{.nextflow-primary} Nextflow for Newcomers
...
!!! catalog "Advanced track"
    ...
    ??? courses "Side Quests: Deep dives into standalone topics"
        ...
        [Browse the Side Quests :material-arrow-right:](side_quests/){ .md-button .md-button--primary }
