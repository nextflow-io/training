...
- Commencez avec nf-core avec [Build with nf-core](../hello_nf-core/index.md)
- Apprenez les techniques de dépannage avec le [Debugging Side Quest](../side_quests/debugging/index.md)
