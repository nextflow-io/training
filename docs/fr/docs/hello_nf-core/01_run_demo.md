...
Maintenant que nous avons exécuté avec succès le pipeline en tant qu'utilisateurs, changeons de perspective pour voir comment les pipelines nf-core sont structurés en interne.
