...
Félicitations pour avoir terminé le cours de formation Build with nf-core ! 🎉

<!-- placeholder for video -->

## Votre parcours

Vous avez commencé par aborder la conversion d'un simple workflow Nextflow en pipeline nf-core.
