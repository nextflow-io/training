...
Ce cours de formation est destiné aux chercheur·euses en imagerie et biologie spatiale qui souhaitent exécuter et personnaliser des pipelines d'analyse de données.
Il enseigne les concepts fondamentaux de Nextflow liés à l'exécution, l'organisation et la configuration de workflows en utilisant [nf-core/molkart](https://nf-co.re/molkart), un pipeline pour le traitement des données de transcriptomique spatiale Molecular Cartography.
