...
Ce cours de formation s'adresse aux chercheurs en imagerie et biologie spatiale qui souhaitent exécuter et personnaliser des pipelines d'analyse de données.
