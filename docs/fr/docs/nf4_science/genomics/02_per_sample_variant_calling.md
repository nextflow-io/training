...
Lorsque vous vous sentirez rafraîchi·e, rendez-vous à la [Partie 3](./03_joint_calling.md), où vous apprendrez comment transformer ce simple workflow d'appel de variants par échantillon pour appliquer l'appel de variants conjoint aux données.
