...
Ce cours s'appuie sur la formation pour débutant·es [Hello Nextflow](../../hello_nextflow/index.md) et démontre comment utiliser Nextflow dans le contexte spécifique du domaine {DOMAIN}.
