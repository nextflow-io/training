...
Ensuite, vous avez construit un pipeline Nextflow pour un seul échantillon afin d'automatiser le processus, vous l'avez étendu pour gérer plusieurs échantillons en parallèle, et vous l'avez enrichi pour traiter des données paired-end et agréger des rapports QC sur l'ensemble des échantillons.
...
- Démarrer avec nf-core avec [Build with nf-core](../../hello_nf-core/index.md)
