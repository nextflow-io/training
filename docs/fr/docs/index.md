...
- :material-book-open-variant:{ .lg .middle } **Cours en libre-service**
...
- :material-information-outline:{ .lg .middle } **Informations complémentaires**
...
- :material-walk:{ .lg .middle } **Parcours d'introduction**
...
- :material-run:{ .lg .middle } **Parcours avancé**
