...
-   :material-walk:{ .lg .middle } __Parcours d'introduction__
    ...
    ??? courses "**Hello Nextflow :** Apprenez à développer vos propres pipelines"
        ...
        Ce cours couvre les composants principaux du langage Nextflow avec suffisamment de détails pour permettre de développer des pipelines simples mais entièrement fonctionnels, ainsi que les éléments clés de la conception, du développement et des pratiques de configuration de pipelines.
...
-   :material-run:{ .lg .middle } __Parcours avancé__
    ...
    ??? courses "**Hello nf-core :** Démarrez avec nf-core"
        ...
        Pour les développeur·ses qui souhaitent apprendre à exécuter et développer des pipelines conformes à [nf-core](https://nf-co.re/). Le cours couvre la structure des pipelines nf-core avec suffisamment de détails pour permettre de développer des pipelines simples mais entièrement fonctionnels qui suivent le template nf-core et les bonnes pratiques de développement, ainsi que d'utiliser les modules nf-core existants.
