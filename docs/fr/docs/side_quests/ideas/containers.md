...
Vous pouvez également poursuivre avec un exercice optionnel pour récupérer des citations de pionniers de l'informatique/biologie en utilisant le conteneur `quote` et les afficher en utilisant le conteneur `cowsay`.
