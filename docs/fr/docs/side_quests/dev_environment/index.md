...
Ce guide suppose que vous avez suivi le cours de formation [Hello Nextflow](../../hello_nextflow/index.md) et que vous êtes à l'aise avec les concepts fondamentaux de Nextflow, notamment :
...
Essayez de rechercher `container` dans tout l'espace de travail :

![Recherche dans le projet](../img/project_search.png)

Cela vous montre chaque fichier qui utilise la directive container, vous aidant à :

- Comprendre quels processus utilisent des conteneurs
...
- **[Hello nf-core](../../hello_nf-core/index.md)** : Construisez des pipelines de qualité production avec les standards de la communauté
