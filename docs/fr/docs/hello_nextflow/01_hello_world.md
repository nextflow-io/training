...
Heureusement, Nextflow dispose d'un système de paramètres de workflow intégré appelé [`params`](https://nextflow.io/docs/latest/config.html#params) qui facilite la déclaration et l'utilisation des paramètres CLI.
