...
additional_information:
    ...
    learning_objectives:
        - Lancer et gérer l'exécution des workflows Nextflow
        - Trouver et interpréter les sorties (résultats) et fichiers de log générés par Nextflow
        - Résoudre les problèmes de base
        - Construire un workflow simple à plusieurs étapes à partir des composants essentiels de Nextflow
        - Distinguer les types essentiels de fabriques de canaux et d'opérateurs et les utiliser efficacement dans un workflow simple
...
**Hello Nextflow est une introduction pratique à la construction de workflows d'analyse de données reproductibles et évolutifs.**
...
Vous repartirez avec les compétences et la confiance nécessaires pour commencer à développer et exécuter vos propres workflows avec Nextflow.
...
| ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------- |
| [Partie 1 : Hello World](./01_hello_world.md)           | Composants de base et principes impliqués dans l'assemblage et l'exécution d'un workflow Nextflow                       | 30 min        |
...
À la fin de ce cours, vous serez bien préparé·e pour aborder les prochaines étapes de votre parcours pour développer des workflows reproductibles pour vos besoins de calcul scientifique.
