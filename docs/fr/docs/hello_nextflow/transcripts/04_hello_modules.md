...
Les modules Nextflow nous permettent d'extraire les processus de ce script principal et ensuite de les importer. Cela signifie que le code est plus facile à parcourir et cela signifie également que nous pouvons partager ce code de module entre différents pipelines.
...
Et maintenant notre script de workflow principal semble soudainement beaucoup, beaucoup plus court, beaucoup plus accessible et beaucoup plus facile à lire.
