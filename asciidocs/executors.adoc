...
Run the RNA-Seq script (script7.nf) from earlier, but specify that the `quantification` `process` reuires 2 CPUs and 5 GB of memory, within the `nextflow.config` file.
