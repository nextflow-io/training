...
NOTE: the input declaration defines a `$transcriptome` variable in the process context
...
2. How to avoid the use of absolute paths having your scripts in the `bin/` folder.
