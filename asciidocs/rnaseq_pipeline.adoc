...
IMPORTANT: Resource requirements such as CPU and memory can change with different workflow executions and platforms. Nextflow can use $task.cpus as a variable for the number of CPUs. We will learn more about this later.
...
For extra practice, you can also try asking for more cpu than you have to see what happens and the error it kicks out.
====
