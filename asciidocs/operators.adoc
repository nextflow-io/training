...
There are seven main groups of operators are described in greater detail below:
...
<2> Create a new channel, transforming each number into its square
...
This operator is useful to process to group together all elements that share a common
