...
The second is to use Gitpod (see section 1.2), which is best for first timers, as this platform containes all the programs and data required (click the link, login via your GitHub account, and start the tutorial!).
