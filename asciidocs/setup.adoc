...
There are many ways to get started with the Nextflow training course. We recommend Gitpod (see later) for its simplicity, as this is a closed environment with all the programs and material installed.
