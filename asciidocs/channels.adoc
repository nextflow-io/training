...
A _queue_ channel is an _asynchronous_ unidirectional _FIFO_ queue which connects two processes or operators.
...
some inconsistent behavior of the latter and provides a better handling when specifying a range of values. 
For example:
