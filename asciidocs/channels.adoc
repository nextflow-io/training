...
The method `Channel.of` works in a similar manner to `Channel.from` (which is now https://www.nextflow.io/docs/latest/channel.html#of[deprecated]), though it fixes
