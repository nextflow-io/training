...
Carefully review all error data as it can provide information valuable for dubugging. 
...
set the number of attempts the task can be re-execute before declaring it failed with an error condition. 
