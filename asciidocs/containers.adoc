...
Try to run the RNA-Seq experiment from earlier (script6.nf), but start by building your own conda `Dockerfile` (from above), save to your docker hub repo and then point Nextflow to run from this container. 
