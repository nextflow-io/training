...
NOTE: Storing processes in separate files or in one big file, is completely up to you. It can be helpful to see examples on public repos. e.g. seqera RNA-Seq tutorial [
https://github.com/seqeralabs/rnaseq-nf/tree/master/modules[here] or within nf-cores projects e.g.: https://github.com/nf-core/rnaseq/tree/master/modules/nf-core/modules[here]
