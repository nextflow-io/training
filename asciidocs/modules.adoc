...
https://github.com/seqeralabs/rnaseq-nf/tree/master/modules[here] or within nf-core projects  https://github.com/nf-core/rnaseq/tree/master/modules/nf-core/modules[here].
