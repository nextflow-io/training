...
<18> Triple quote marks initiate the code block to execute in this `process`.
...
relevant paths to screen, use the `-ansi-log` flag (e.g. `nextflow run hello.nf -ansi-log false`).
