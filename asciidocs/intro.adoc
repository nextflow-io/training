...
The second receives the output of the first process and splits the two words into spearate items (using .flatten). These two words are then converted to uppercase letters. 
