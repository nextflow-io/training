...
that, in turn, is a super-set of the Java programming language. Groovy can be thought of as Python for Java, in that it simplifies the writing of code and is more approachable.
...
Now copy the following example into your favourite text editor and save it to a file named `hello.nf`.
