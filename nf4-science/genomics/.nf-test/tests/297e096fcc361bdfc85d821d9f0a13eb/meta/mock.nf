...
workflow {
    ...
    def input = []
                ...
                // input[0] = Channel.fromPath(params.reads_bam).splitText() // reads_ch = Channel.fromPath(params.reads_bam).splitText()
                input[0] = file("/Users/joostgroot/Work_local/NextFlow/nextflow_projects/test_training/training/nf4-science/genomics/data/bam/reads_son.bam")
