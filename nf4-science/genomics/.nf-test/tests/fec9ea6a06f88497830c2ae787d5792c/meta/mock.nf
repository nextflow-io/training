...
include { SAMTOOLS_INDEX  } from '/workspaces/training/nf4-science/genomics/modules/gatk/haplotypecaller/tests/../../../samtools/index/main.nf'


// include test process
include { GATK_HAPLOTYPECALLER } from '/workspaces/training/nf4-science/genomics/modules/gatk/haplotypecaller/tests/../main.nf'
...
workflow {
    ...
    
    {
        def input = []
                    ...
                    input[0] =  file("/workspaces/training/nf4-science/genomics/data/bam/reads_father.bam")
